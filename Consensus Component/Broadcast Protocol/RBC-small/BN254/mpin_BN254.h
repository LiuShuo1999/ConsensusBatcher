...
#define PGS_BN254 MODBYTES_256_28  /**< MPIN Group Size */
#define PFS_BN254 MODBYTES_256_28  /**< MPIN Field Size */
...
//#define PAS_BN254 16        /**< MPIN Symmetric Key Size 128 bits */
//#define HASH_TYPE_MPIN_BN254 SHA256   /**< Choose Hash function */
 ...
 */
int MPIN_BN254_EXTRACT_PIN(octet *HID, int pin, octet *CS);
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BN254_CLIENT_1(octet *HID, csprng *R, octet *x, int pin, octet *T, octet *S, octet *U);
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BN254_RANDOM_GENERATE(csprng *R, octet *S);
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BN254_CLIENT_2(octet *x, octet *y, octet *V);
...
/**	@brief Perform final pass on the server side of the M-Pin protocol
	...
	@return 0 or an error code
 */
int MPIN_BN254_SERVER(octet *HID, octet *y, octet *SS, octet *U, octet *V);
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BN254_GET_CLIENT_SECRET(octet *S, octet *HID, octet *CS);
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BN254_GET_SERVER_SECRET(octet *S, octet *SS);
