...
#define EVENT_VAL_CBC_EF_STATE (1<<12)
...
/*******************VAL_CBC**************************************/
extern u8 VAL_CBC_v[MAX_Nodes][Block_Num][CBC_block_Size];
extern u8 ACK_VAL_CBC[MAX_Nodes][Block_Num];
