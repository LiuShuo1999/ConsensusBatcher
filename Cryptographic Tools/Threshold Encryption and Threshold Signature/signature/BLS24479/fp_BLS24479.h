...
#ifndef FP_BLS24479_H
#define FP_BLS24479_H
...
typedef struct
{
    BIG_480_29 g;	/**< Big representation of field element */
    sign32 XES;	/**< Excess */
} FP_BLS24479;


/* Field Params - see rom.c */
extern const BIG_480_29 Modulus_BLS24479;	/**< Actual Modulus set in rom_field_yyy.c */
extern const BIG_480_29 ROI_BLS24479;	    /**< Root of unity set in rom_field_yyy.c */
extern const BIG_480_29 R2modp_BLS24479;	/**< Montgomery constant */
extern const BIG_480_29 CRu_BLS24479;       /**< Cube Root of Unity */
extern const BIG_480_29 SQRTm3_BLS24479; /**< Square root of -3 */
extern const BIG_480_29 TWK_BLS24479; /**< Tweak for square roots, pre-calculated from field norm */
extern const chunk MConst_BLS24479;		/**< Constant associated with Modulus - for Montgomery = 1/p mod 2^BASEBITS */


#define MODBITS_BLS24479 MBITS_BLS24479                        /**< Number of bits in Modulus for selected curve */
#define TBITS_BLS24479 (MBITS_BLS24479%BASEBITS_480_29)           /**< Number of active bits in top word */
#define TMASK_BLS24479 (((chunk)1<<TBITS_BLS24479)-1)          /**< Mask for active bits in top word */
#define FEXCESS_BLS24479 (((sign32)1<<MAXXES_BLS24479)-1)	     /**< 2^(BASEBITS*NLEN-MODBITS)-1 - normalised BIG can be multiplied by less than this before reduction */
#define OMASK_BLS24479 (-((chunk)(1)<<TBITS_BLS24479))         /**<  for masking out overflow bits */

//#define BIG_ENDIAN_SIGN_BLS24479 
 ...
 *
	...
	@param a integer
 */
extern void FP_BLS24479_from_int(FP_BLS24479 *x,int a);
 ...
 */
extern int FP_BLS24479_iszilch(FP_BLS24479 *x);
 ...
 */
extern int FP_BLS24479_islarger(FP_BLS24479 *x);
 ...
 */
extern void FP_BLS24479_toBytes(char *b,FP_BLS24479 *x);
 ...
 */
extern void FP_BLS24479_fromBytes(FP_BLS24479 *x,char *b);
 ...
 */
extern int FP_BLS24479_isunity(FP_BLS24479 *x);
 ...
 */
extern void FP_BLS24479_zero(FP_BLS24479 *x);
 ...
 */
extern void FP_BLS24479_copy(FP_BLS24479 *y, FP_BLS24479 *x);
 ...
 */
extern void FP_BLS24479_rcopy(FP_BLS24479 *y, const BIG_480_29 x);
 ...
 */
extern int FP_BLS24479_equals(FP_BLS24479 *x, FP_BLS24479 *y);
 ...
 */
extern void FP_BLS24479_cswap(FP_BLS24479 *x, FP_BLS24479 *y, int s);
 ...
 */
extern int FP_BLS24479_sign(FP_BLS24479 *x);
 ...
 */
extern void FP_BLS24479_mod(BIG_480_29 r, DBIG_480_29 d);

#ifdef FUSED_MODMUL
extern void FP_BLS24479_modmul(BIG_480_29, BIG_480_29, BIG_480_29);
#endif
 ...
 */
extern void FP_BLS24479_mul(FP_BLS24479 *x, FP_BLS24479 *y, FP_BLS24479 *z);
 ...
 */
extern void FP_BLS24479_imul(FP_BLS24479 *x, FP_BLS24479 *y, int i);
 ...
 */
extern void FP_BLS24479_sqr(FP_BLS24479 *x, FP_BLS24479 *y);
 ...
 *
	...
	@param z FP number
 */
extern void FP_BLS24479_add(FP_BLS24479 *x, FP_BLS24479 *y, FP_BLS24479 *z);
 ...
 *
	...
	@param z FP number
 */
extern void FP_BLS24479_sub(FP_BLS24479 *x, FP_BLS24479 *y, FP_BLS24479 *z);
/**	@brief Modular division by 2 of an FP, mod Modulus
 *
	@param x FP number, on exit =y/2 mod Modulus
	@param y FP number
 */
extern void FP_BLS24479_div2(FP_BLS24479 *x, FP_BLS24479 *y);
 ...
 */
extern void FP_BLS24479_pow(FP_BLS24479 *x, FP_BLS24479 *y, BIG_480_29 z);
 ...
 *
	...
	@param x FP number
 */
extern void FP_BLS24479_progen(FP_BLS24479 *r,FP_BLS24479 *x);
 ...
 */
extern void FP_BLS24479_sqrt(FP_BLS24479 *x, FP_BLS24479 *y, FP_BLS24479 *h);
 ...
 */
extern int FP_BLS24479_qr(FP_BLS24479 *x,FP_BLS24479 *h);
 ...
 *
	...
	@return 1 if quadratic residue, else returns 0 if quadratic non-residue
 */
extern int FP_BLS24479_invsqrt(FP_BLS24479 *i,FP_BLS24479 *s,FP_BLS24479 *x);
 ...
 *
	...
	@return 1 if quadratic residue, else returns 0 if quadratic non-residue
 */
extern int FP_BLS24479_tpo(FP_BLS24479 *i, FP_BLS24479 *s);
 ...
 */
extern void FP_BLS24479_inv(FP_BLS24479 *x, FP_BLS24479 *y, FP_BLS24479 *h);
 ...
 */
extern void FP_BLS24479_rand(FP_BLS24479 *x, csprng *rng);
