...
#ifndef MPIN_FP512BN_H
#define MPIN_FP512BN_H

#include "pair_FP512BN.h"

/* Field size is assumed to be greater than or equal to group size */

#define PGS_FP512BN MODBYTES_512_29  /**< MPIN Group Size */
#define PFS_FP512BN MODBYTES_512_29  /**< MPIN Field Size */
...
//#define PAS_FP512BN 16        /**< MPIN Symmetric Key Size 128 bits */
//#define HASH_TYPE_MPIN_FP512BN SHA256   /**< Choose Hash function */
 ...
 */
int MPIN_FP512BN_EXTRACT_PIN(octet *HID, int pin, octet *CS);
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_FP512BN_CLIENT_1(octet *HID, csprng *R, octet *x, int pin, octet *T, octet *S, octet *U);
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_FP512BN_RANDOM_GENERATE(csprng *R, octet *S);
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_FP512BN_CLIENT_2(octet *x, octet *y, octet *V);
...
/**	@brief Perform final pass on the server side of the M-Pin protocol
	...
	@return 0 or an error code
 */
int MPIN_FP512BN_SERVER(octet *HID, octet *y, octet *SS, octet *U, octet *V);
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_FP512BN_GET_CLIENT_SECRET(octet *S, octet *HID, octet *CS);
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_FP512BN_GET_SERVER_SECRET(octet *S, octet *SS);
