...
#ifndef EDDSA_FP512BN_H
#define EDDSA_FP512BN_H
 ...
 */
extern int EDDSA_FP512BN_KEY_PAIR_GENERATE(csprng *R, octet *D, octet *Q);
 ...
 *
	...
	@return 0 or an error code
 */
extern int EDDSA_FP512BN_SIGNATURE(bool ph,octet *D, octet *context,octet *M,octet *SIG);
 ...
 */
extern bool EDDSA_FP512BN_VERIFY(bool ph,octet *Q,octet *context,octet *M,octet *SIG);
#endif