...
#ifndef FP4_FP512BN_H
#define FP4_FP512BN_H
...
typedef struct
{
    FP2_FP512BN a; /**< real part of FP4 */
    FP2_FP512BN b; /**< imaginary part of FP4 */
} FP4_FP512BN;
 ...
 */
extern int FP4_FP512BN_iszilch(FP4_FP512BN *x);
 ...
 */
extern int FP4_FP512BN_islarger(FP4_FP512BN *x);
 ...
 */
extern void FP4_FP512BN_toBytes(char *b,FP4_FP512BN *x);
 ...
 */
extern void FP4_FP512BN_fromBytes(FP4_FP512BN *x,char *b);
 ...
 */
extern int FP4_FP512BN_isunity(FP4_FP512BN *x);
 ...
 */
extern int FP4_FP512BN_equals(FP4_FP512BN *x, FP4_FP512BN *y);
/**	@brief Tests for FP4 having only a real part and no imaginary part
 *
	@param x FP4 number to be tested
	@return 1 if real, else returns 0
 */
extern int FP4_FP512BN_isreal(FP4_FP512BN *x);
 ...
 */
extern void FP4_FP512BN_from_FP2s(FP4_FP512BN *x, FP2_FP512BN *a, FP2_FP512BN *b);
 ...
 *
	...
	@param a FP2 to form real part of FP4
 */
extern void FP4_FP512BN_from_FP2(FP4_FP512BN *x, FP2_FP512BN *a);
 ...
 */
extern void FP4_FP512BN_from_FP2H(FP4_FP512BN *x, FP2_FP512BN *a);
 ...
 */
extern void FP4_FP512BN_from_FP(FP4_FP512BN *x, FP_FP512BN *a);
 ...
 */
extern void FP4_FP512BN_copy(FP4_FP512BN *x, FP4_FP512BN *y);
/**	@brief Set FP4 to zero
 *
	@param x FP4 instance to be set to zero
 */
extern void FP4_FP512BN_zero(FP4_FP512BN *x);
/**	@brief Set FP4 to unity
 *
	@param x FP4 instance to be set to one
 */
extern void FP4_FP512BN_one(FP4_FP512BN *x);
 ...
 *
	...
	@return "sign" of FP4
 */
extern int FP4_FP512BN_sign(FP4_FP512BN *x);
 ...
 */
extern void FP4_FP512BN_neg(FP4_FP512BN *x, FP4_FP512BN *y);
 ...
 *
	...
	@param y FP4 instance
 */
extern void FP4_FP512BN_conj(FP4_FP512BN *x, FP4_FP512BN *y);
 ...
 *
	...
	@param y FP4 instance
 */
extern void FP4_FP512BN_nconj(FP4_FP512BN *x, FP4_FP512BN *y);
 ...
 */
extern void FP4_FP512BN_add(FP4_FP512BN *x, FP4_FP512BN *y, FP4_FP512BN *z);
 ...
 *
	...
	@param z FP4 instance
 */
extern void FP4_FP512BN_sub(FP4_FP512BN *x, FP4_FP512BN *y, FP4_FP512BN *z);
 ...
 */
extern void FP4_FP512BN_pmul(FP4_FP512BN *x, FP4_FP512BN *y, FP2_FP512BN *a);
 ...
 */
extern void FP4_FP512BN_qmul(FP4_FP512BN *x, FP4_FP512BN *y, FP_FP512BN *a);
 ...
 *
	...
	@param i an integer
 */
extern void FP4_FP512BN_imul(FP4_FP512BN *x, FP4_FP512BN *y, int i);
/**	@brief Squaring an FP4
 *
	@param x FP4 instance, on exit = y^2
	@param y FP4 instance
 */
extern void FP4_FP512BN_sqr(FP4_FP512BN *x, FP4_FP512BN *y);
 ...
 *
	...
	@param z FP4 instance
 */
extern void FP4_FP512BN_mul(FP4_FP512BN *x, FP4_FP512BN *y, FP4_FP512BN *z);
 ...
 *
	...
	@param b BIG number
 */
extern void FP4_FP512BN_pow(FP4_FP512BN *x, FP4_FP512BN *y, BIG_512_29 b);
/**	@brief Raises an FP4 to the power of the internal modulus p, using the Frobenius
 *
	@param x FP4 instance, on exit = x^p
	@param f FP2 precalculated Frobenius constant
 */
extern void FP4_FP512BN_frob(FP4_FP512BN *x, FP2_FP512BN *f);
 ...
 *
	...
	@param z FP4 instance
 */
extern void FP4_FP512BN_xtr_A(FP4_FP512BN *r, FP4_FP512BN *w, FP4_FP512BN *x, FP4_FP512BN *y, FP4_FP512BN *z);
/**	@brief Calculates the XTR doubling function r=x^2-2*conj(x)
 *
	@param r FP4 instance, on exit = x^2-2*conj(x)
	@param x FP4 instance
 */
extern void FP4_FP512BN_xtr_D(FP4_FP512BN *r, FP4_FP512BN *x);
 ...
 *
	...
	@param b BIG number
 */
extern void FP4_FP512BN_xtr_pow(FP4_FP512BN *r, FP4_FP512BN *x, BIG_512_29 b);
 ...
 *
	...
	@param b BIG number
 */
extern void FP4_FP512BN_xtr_pow2(FP4_FP512BN *r, FP4_FP512BN *c, FP4_FP512BN *d, FP4_FP512BN *e, FP4_FP512BN *f, BIG_512_29 a, BIG_512_29 b);
 ...
 */
extern void FP4_FP512BN_cmove(FP4_FP512BN *x, FP4_FP512BN *y, int s);
 ...
 */
extern int  FP4_FP512BN_qr(FP4_FP512BN *r, FP_FP512BN *h);
 ...
 *
	...
	@param h optional input hint
 */
extern void  FP4_FP512BN_sqrt(FP4_FP512BN *r, FP4_FP512BN *x, FP_FP512BN *h);
 ...
 *
	...
	@param x FP4 instance
 */
extern void FP4_FP512BN_div_i(FP4_FP512BN *x);
 ...
 *
	...
	@param x FP4 instance
 */
extern void FP4_FP512BN_div_2i(FP4_FP512BN *x);
 ...
 *
	...
	@param y FP4 instance
 */
extern void FP4_FP512BN_div2(FP4_FP512BN *x, FP4_FP512BN *y);
 ...
 */
extern void FP4_FP512BN_rand(FP4_FP512BN *x, csprng *rng);
