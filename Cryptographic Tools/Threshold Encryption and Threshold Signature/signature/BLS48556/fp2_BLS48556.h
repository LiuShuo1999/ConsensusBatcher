...
#ifndef FP2_BLS48556_H
#define FP2_BLS48556_H
...
typedef struct
{
    FP_BLS48556 a; /**< real part of FP2 */
    FP_BLS48556 b; /**< imaginary part of FP2 */
} FP2_BLS48556;
 ...
 */
extern int FP2_BLS48556_iszilch(FP2_BLS48556 *x);
 ...
 */
extern int FP2_BLS48556_islarger(FP2_BLS48556 *x);
 ...
 */
extern void FP2_BLS48556_toBytes(char *b,FP2_BLS48556 *x);
 ...
 */
extern void FP2_BLS48556_fromBytes(FP2_BLS48556 *x,char *b);
 ...
 */
extern void FP2_BLS48556_cmove(FP2_BLS48556 *x, FP2_BLS48556 *y, int s);
/**	@brief Tests for FP2 equal to one
 *
	@param x FP2 instance to be tested
	@return 1 if x=1, else returns 0
 */
extern int FP2_BLS48556_isunity(FP2_BLS48556 *x);
 ...
 */
extern int FP2_BLS48556_equals(FP2_BLS48556 *x, FP2_BLS48556 *y);
 ...
 */
extern void FP2_BLS48556_from_FPs(FP2_BLS48556 *x, FP_BLS48556 *a, FP_BLS48556 *b);
 ...
 */
extern void FP2_BLS48556_from_BIGs(FP2_BLS48556 *x, BIG_560_29 a, BIG_560_29 b);
 ...
 */
extern void FP2_BLS48556_from_ints(FP2_BLS48556 *x, int a, int b);
 ...
 *
	...
	@param a FP to form real part of FP2
 */
extern void FP2_BLS48556_from_FP(FP2_BLS48556 *x, FP_BLS48556 *a);
 ...
 */
extern void FP2_BLS48556_rcopy(FP2_BLS48556 *w,const BIG_560_29 a,const BIG_560_29 b);
 ...
 *
	...
	@return "sign" of FP2
 */
extern int FP2_BLS48556_sign(FP2_BLS48556 *x);
 ...
 */
extern void FP2_BLS48556_neg(FP2_BLS48556 *x, FP2_BLS48556 *y);
 ...
 *
	...
	@param y FP2 instance
 */
extern void FP2_BLS48556_conj(FP2_BLS48556 *x, FP2_BLS48556 *y);
 ...
 */
extern void FP2_BLS48556_add(FP2_BLS48556 *x, FP2_BLS48556 *y, FP2_BLS48556 *z);
 ...
 *
	...
	@param z FP2 instance
 */
extern void FP2_BLS48556_sub(FP2_BLS48556 *x, FP2_BLS48556 *y, FP2_BLS48556 *z);
 ...
 *
	...
	@param b FP residue
 */
extern void FP2_BLS48556_pmul(FP2_BLS48556 *x, FP2_BLS48556 *y, FP_BLS48556 *b);
 ...
 *
	...
	@param i an integer
 */
extern void FP2_BLS48556_imul(FP2_BLS48556 *x, FP2_BLS48556 *y, int i);
/**	@brief Squaring an FP2
 *
	@param x FP2 instance, on exit = y^2
	@param y FP2 instance
 */
extern void FP2_BLS48556_sqr(FP2_BLS48556 *x, FP2_BLS48556 *y);
 ...
 *
	...
	@param z FP2 instance
 */
extern void FP2_BLS48556_mul(FP2_BLS48556 *x, FP2_BLS48556 *y, FP2_BLS48556 *z);
/**	@brief Formats and outputs an FP2 to the console
 *
	@param x FP2 instance
 */
extern void FP2_BLS48556_output(FP2_BLS48556 *x);
/**	@brief Formats and outputs an FP2 to the console in raw form (for debugging)
 *
	@param x FP2 instance
 */
extern void FP2_BLS48556_rawoutput(FP2_BLS48556 *x);
 ...
 *
	...
	@param b BIG number
 */
extern void FP2_BLS48556_pow(FP2_BLS48556 *x, FP2_BLS48556 *y, BIG_560_29 b);
 ...
 */
extern int FP2_BLS48556_qr(FP2_BLS48556 *x, FP_BLS48556 *h);
 ...
 *
    ...
    @param h optional input hint
 */
extern void FP2_BLS48556_sqrt(FP2_BLS48556 *x, FP2_BLS48556 *y, FP_BLS48556 *h);
 ...
 */
extern void FP2_BLS48556_times_i(FP2_BLS48556 *x);
/**	@brief Generate random FP2
 *
	@param x random FP2 number
	@param rng random number generator
 */
extern void FP2_BLS48556_rand(FP2_BLS48556 *x, csprng *rng);
#endif
