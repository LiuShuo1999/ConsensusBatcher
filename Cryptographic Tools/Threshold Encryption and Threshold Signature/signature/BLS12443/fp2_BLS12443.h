...
#ifndef FP2_BLS12443_H
#define FP2_BLS12443_H
...
typedef struct
{
    FP_BLS12443 a; /**< real part of FP2 */
    FP_BLS12443 b; /**< imaginary part of FP2 */
} FP2_BLS12443;
 ...
 */
extern int FP2_BLS12443_iszilch(FP2_BLS12443 *x);
 ...
 */
extern int FP2_BLS12443_islarger(FP2_BLS12443 *x);
 ...
 */
extern void FP2_BLS12443_toBytes(char *b,FP2_BLS12443 *x);
 ...
 */
extern void FP2_BLS12443_fromBytes(FP2_BLS12443 *x,char *b);
 ...
 */
extern void FP2_BLS12443_cmove(FP2_BLS12443 *x, FP2_BLS12443 *y, int s);
/**	@brief Tests for FP2 equal to one
 *
	@param x FP2 instance to be tested
	@return 1 if x=1, else returns 0
 */
extern int FP2_BLS12443_isunity(FP2_BLS12443 *x);
 ...
 */
extern int FP2_BLS12443_equals(FP2_BLS12443 *x, FP2_BLS12443 *y);
 ...
 */
extern void FP2_BLS12443_from_FPs(FP2_BLS12443 *x, FP_BLS12443 *a, FP_BLS12443 *b);
 ...
 */
extern void FP2_BLS12443_from_BIGs(FP2_BLS12443 *x, BIG_448_29 a, BIG_448_29 b);
 ...
 */
extern void FP2_BLS12443_from_ints(FP2_BLS12443 *x, int a, int b);
 ...
 *
	...
	@param a FP to form real part of FP2
 */
extern void FP2_BLS12443_from_FP(FP2_BLS12443 *x, FP_BLS12443 *a);
 ...
 */
extern void FP2_BLS12443_rcopy(FP2_BLS12443 *w,const BIG_448_29 a,const BIG_448_29 b);
 ...
 *
	...
	@return "sign" of FP2
 */
extern int FP2_BLS12443_sign(FP2_BLS12443 *x);
 ...
 */
extern void FP2_BLS12443_neg(FP2_BLS12443 *x, FP2_BLS12443 *y);
 ...
 *
	...
	@param y FP2 instance
 */
extern void FP2_BLS12443_conj(FP2_BLS12443 *x, FP2_BLS12443 *y);
 ...
 */
extern void FP2_BLS12443_add(FP2_BLS12443 *x, FP2_BLS12443 *y, FP2_BLS12443 *z);
 ...
 *
	...
	@param z FP2 instance
 */
extern void FP2_BLS12443_sub(FP2_BLS12443 *x, FP2_BLS12443 *y, FP2_BLS12443 *z);
 ...
 *
	...
	@param b FP residue
 */
extern void FP2_BLS12443_pmul(FP2_BLS12443 *x, FP2_BLS12443 *y, FP_BLS12443 *b);
 ...
 *
	...
	@param i an integer
 */
extern void FP2_BLS12443_imul(FP2_BLS12443 *x, FP2_BLS12443 *y, int i);
/**	@brief Squaring an FP2
 *
	@param x FP2 instance, on exit = y^2
	@param y FP2 instance
 */
extern void FP2_BLS12443_sqr(FP2_BLS12443 *x, FP2_BLS12443 *y);
 ...
 *
	...
	@param z FP2 instance
 */
extern void FP2_BLS12443_mul(FP2_BLS12443 *x, FP2_BLS12443 *y, FP2_BLS12443 *z);
/**	@brief Formats and outputs an FP2 to the console
 *
	@param x FP2 instance
 */
extern void FP2_BLS12443_output(FP2_BLS12443 *x);
/**	@brief Formats and outputs an FP2 to the console in raw form (for debugging)
 *
	@param x FP2 instance
 */
extern void FP2_BLS12443_rawoutput(FP2_BLS12443 *x);
 ...
 *
	...
	@param b BIG number
 */
extern void FP2_BLS12443_pow(FP2_BLS12443 *x, FP2_BLS12443 *y, BIG_448_29 b);
 ...
 */
extern int FP2_BLS12443_qr(FP2_BLS12443 *x, FP_BLS12443 *h);
 ...
 *
    ...
    @param h optional input hint
 */
extern void FP2_BLS12443_sqrt(FP2_BLS12443 *x, FP2_BLS12443 *y, FP_BLS12443 *h);
 ...
 */
extern void FP2_BLS12443_times_i(FP2_BLS12443 *x);
/**	@brief Generate random FP2
 *
	@param x random FP2 number
	@param rng random number generator
 */
extern void FP2_BLS12443_rand(FP2_BLS12443 *x, csprng *rng);
#endif
