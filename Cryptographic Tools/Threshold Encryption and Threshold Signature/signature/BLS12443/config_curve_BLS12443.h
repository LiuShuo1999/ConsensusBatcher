...
#define CURVETYPE_BLS12443 WEIERSTRASS          /**< Define Curve Type */
#define CURVE_A_BLS12443 0            /**< Curve A parameter */
#define PAIRING_FRIENDLY_BLS12443 BLS12_CURVE   /**< Is curve pairing-friendly */
#define CURVE_SECURITY_BLS12443 128     /**< Curve security level in AES bits */
#define HTC_ISO_BLS12443 11            /**< Use Isogenies for Hash to Curve */
...
#define HTC_ISO_G2_BLS12443 3        /**< Use Isogenies for G2 Hash to Curve */
...
#define USE_GS_GT_BLS12443 /**< Not patented, so probably OK to always use this */

#define POSITIVEX 0
#define NEGATIVEX 1

#define SEXTIC_TWIST_BLS12443 M_TYPE       /**< Sextic Twist M or D type */
#define SIGN_OF_X_BLS12443 POSITIVEX          /**< Sign of curve parameter */ 

#define ATE_BITS_BLS12443 75           /**< Number of Bits in curve parameter */
#define G2_TABLE_BLS12443 78           /**< Size of table for pairing precomputation for fixed G2 */
