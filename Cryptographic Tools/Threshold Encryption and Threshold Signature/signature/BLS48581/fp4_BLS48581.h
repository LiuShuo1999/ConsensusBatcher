...
#ifndef FP4_BLS48581_H
#define FP4_BLS48581_H
...
typedef struct
{
    FP2_BLS48581 a; /**< real part of FP4 */
    FP2_BLS48581 b; /**< imaginary part of FP4 */
} FP4_BLS48581;
 ...
 */
extern int FP4_BLS48581_iszilch(FP4_BLS48581 *x);
 ...
 */
extern int FP4_BLS48581_islarger(FP4_BLS48581 *x);
 ...
 */
extern void FP4_BLS48581_toBytes(char *b,FP4_BLS48581 *x);
 ...
 */
extern void FP4_BLS48581_fromBytes(FP4_BLS48581 *x,char *b);
 ...
 */
extern int FP4_BLS48581_isunity(FP4_BLS48581 *x);
 ...
 */
extern int FP4_BLS48581_equals(FP4_BLS48581 *x, FP4_BLS48581 *y);
/**	@brief Tests for FP4 having only a real part and no imaginary part
 *
	@param x FP4 number to be tested
	@return 1 if real, else returns 0
 */
extern int FP4_BLS48581_isreal(FP4_BLS48581 *x);
 ...
 */
extern void FP4_BLS48581_from_FP2s(FP4_BLS48581 *x, FP2_BLS48581 *a, FP2_BLS48581 *b);
 ...
 *
	...
	@param a FP2 to form real part of FP4
 */
extern void FP4_BLS48581_from_FP2(FP4_BLS48581 *x, FP2_BLS48581 *a);
 ...
 */
extern void FP4_BLS48581_from_FP2H(FP4_BLS48581 *x, FP2_BLS48581 *a);
 ...
 */
extern void FP4_BLS48581_from_FP(FP4_BLS48581 *x, FP_BLS48581 *a);
 ...
 */
extern void FP4_BLS48581_copy(FP4_BLS48581 *x, FP4_BLS48581 *y);
/**	@brief Set FP4 to zero
 *
	@param x FP4 instance to be set to zero
 */
extern void FP4_BLS48581_zero(FP4_BLS48581 *x);
/**	@brief Set FP4 to unity
 *
	@param x FP4 instance to be set to one
 */
extern void FP4_BLS48581_one(FP4_BLS48581 *x);
 ...
 *
	...
	@return "sign" of FP4
 */
extern int FP4_BLS48581_sign(FP4_BLS48581 *x);
 ...
 */
extern void FP4_BLS48581_neg(FP4_BLS48581 *x, FP4_BLS48581 *y);
 ...
 *
	...
	@param y FP4 instance
 */
extern void FP4_BLS48581_conj(FP4_BLS48581 *x, FP4_BLS48581 *y);
 ...
 *
	...
	@param y FP4 instance
 */
extern void FP4_BLS48581_nconj(FP4_BLS48581 *x, FP4_BLS48581 *y);
 ...
 */
extern void FP4_BLS48581_add(FP4_BLS48581 *x, FP4_BLS48581 *y, FP4_BLS48581 *z);
 ...
 *
	...
	@param z FP4 instance
 */
extern void FP4_BLS48581_sub(FP4_BLS48581 *x, FP4_BLS48581 *y, FP4_BLS48581 *z);
 ...
 */
extern void FP4_BLS48581_pmul(FP4_BLS48581 *x, FP4_BLS48581 *y, FP2_BLS48581 *a);
 ...
 */
extern void FP4_BLS48581_qmul(FP4_BLS48581 *x, FP4_BLS48581 *y, FP_BLS48581 *a);
 ...
 *
	...
	@param i an integer
 */
extern void FP4_BLS48581_imul(FP4_BLS48581 *x, FP4_BLS48581 *y, int i);
/**	@brief Squaring an FP4
 *
	@param x FP4 instance, on exit = y^2
	@param y FP4 instance
 */
extern void FP4_BLS48581_sqr(FP4_BLS48581 *x, FP4_BLS48581 *y);
 ...
 *
	...
	@param z FP4 instance
 */
extern void FP4_BLS48581_mul(FP4_BLS48581 *x, FP4_BLS48581 *y, FP4_BLS48581 *z);
 ...
 *
	...
	@param b BIG number
 */
extern void FP4_BLS48581_pow(FP4_BLS48581 *x, FP4_BLS48581 *y, BIG_584_29 b);
/**	@brief Raises an FP4 to the power of the internal modulus p, using the Frobenius
 *
	@param x FP4 instance, on exit = x^p
	@param f FP2 precalculated Frobenius constant
 */
extern void FP4_BLS48581_frob(FP4_BLS48581 *x, FP2_BLS48581 *f);
 ...
 *
	...
	@param z FP4 instance
 */
extern void FP4_BLS48581_xtr_A(FP4_BLS48581 *r, FP4_BLS48581 *w, FP4_BLS48581 *x, FP4_BLS48581 *y, FP4_BLS48581 *z);
/**	@brief Calculates the XTR doubling function r=x^2-2*conj(x)
 *
	@param r FP4 instance, on exit = x^2-2*conj(x)
	@param x FP4 instance
 */
extern void FP4_BLS48581_xtr_D(FP4_BLS48581 *r, FP4_BLS48581 *x);
 ...
 *
	...
	@param b BIG number
 */
extern void FP4_BLS48581_xtr_pow(FP4_BLS48581 *r, FP4_BLS48581 *x, BIG_584_29 b);
 ...
 *
	...
	@param b BIG number
 */
extern void FP4_BLS48581_xtr_pow2(FP4_BLS48581 *r, FP4_BLS48581 *c, FP4_BLS48581 *d, FP4_BLS48581 *e, FP4_BLS48581 *f, BIG_584_29 a, BIG_584_29 b);
 ...
 */
extern void FP4_BLS48581_cmove(FP4_BLS48581 *x, FP4_BLS48581 *y, int s);
 ...
 */
extern int  FP4_BLS48581_qr(FP4_BLS48581 *r, FP_BLS48581 *h);
 ...
 *
	...
	@param h optional input hint
 */
extern void  FP4_BLS48581_sqrt(FP4_BLS48581 *r, FP4_BLS48581 *x, FP_BLS48581 *h);
 ...
 *
	...
	@param x FP4 instance
 */
extern void FP4_BLS48581_div_i(FP4_BLS48581 *x);
 ...
 *
	...
	@param x FP4 instance
 */
extern void FP4_BLS48581_div_2i(FP4_BLS48581 *x);
 ...
 *
	...
	@param y FP4 instance
 */
extern void FP4_BLS48581_div2(FP4_BLS48581 *x, FP4_BLS48581 *y);
 ...
 */
extern void FP4_BLS48581_rand(FP4_BLS48581 *x, csprng *rng);
