...
typedef struct
{
    FP16_BLS48581 a; /**< first part of FP12 */
    FP16_BLS48581 b; /**< second part of FP12 */
    FP16_BLS48581 c; /**< third part of FP12 */
 ...
 */
extern int FP48_BLS48581_equals(FP48_BLS48581 *x, FP48_BLS48581 *y);
 ...
 */
extern void FP48_BLS48581_conj(FP48_BLS48581 *x, FP48_BLS48581 *y);
 ...
 */
extern void FP48_BLS48581_from_FP16(FP48_BLS48581 *x, FP16_BLS48581 *a);
 ...
 */
extern void FP48_BLS48581_from_FP16s(FP48_BLS48581 *x, FP16_BLS48581 *a, FP16_BLS48581* b, FP16_BLS48581 *c);
/**	@brief Fast Squaring of an FP48 in "unitary" form
 *
	@param x FP48 instance, on exit = y^2
	@param y FP16 instance, must be unitary
 */
extern void FP48_BLS48581_usqr(FP48_BLS48581 *x, FP48_BLS48581 *y);
/**	@brief Squaring an FP48
 *
	@param x FP48 instance, on exit = y^2
	@param y FP48 instance
 */
extern void FP48_BLS48581_sqr(FP48_BLS48581 *x, FP48_BLS48581 *y);
 ...
 */
extern void FP48_BLS48581_smul(FP48_BLS48581 *x, FP48_BLS48581 *y);
 ...
 *
	...
	@param y FP48 instance, of special form
 */
extern void FP48_BLS48581_ssmul(FP48_BLS48581 *x, FP48_BLS48581 *y);
/**	@brief Full unconditional Multiplication of two FP24s
 *
	@param x FP48 instance, on exit = x*y
	@param y FP48 instance, the multiplier
 */
extern void FP48_BLS48581_mul(FP48_BLS48581 *x, FP48_BLS48581 *y);
/**	@brief Inverting an FP48
 *
	@param x FP48 instance, on exit = 1/y
	@param y FP48 instance
 */
extern void FP48_BLS48581_inv(FP48_BLS48581 *x, FP48_BLS48581 *y);
 ...
 *
	...
	@param b BIG number
 */
extern void FP48_BLS48581_pow(FP48_BLS48581 *r, FP48_BLS48581 *x, BIG_584_29 b);
 ...
 */
extern void FP48_BLS48581_pinpow(FP48_BLS48581 *x, int i, int b);

/**	@brief Raises an FP48 instance x to a BIG_584_29 power, compressed to FP16
 *
 ...
 */
extern void FP48_BLS48581_compow(FP16_BLS48581 *c, FP48_BLS48581 *x, BIG_584_29 e, BIG_584_29 r);
 ...
 */
extern void FP48_BLS48581_pow16(FP48_BLS48581 *r, FP48_BLS48581 *x, BIG_584_29 *b);
 ...
 */
extern void FP48_BLS48581_toOctet(octet *S, FP48_BLS48581 *x);
 ...
 */
extern void FP48_BLS48581_fromOctet(FP48_BLS48581 *x, octet *S);
 ...
 */
extern void FP48_BLS48581_trace(FP16_BLS48581 *t, FP48_BLS48581 *x);
 ...
 */
extern void FP48_BLS48581_cmove(FP48_BLS48581 *x, FP48_BLS48581 *y, int s);
