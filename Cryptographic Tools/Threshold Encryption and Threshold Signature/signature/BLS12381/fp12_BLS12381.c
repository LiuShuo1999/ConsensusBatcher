...
void FP12_BLS12381_compow(FP4_BLS12381 *c, FP12_BLS12381 *x, BIG_384_29 e, BIG_384_29 r)
{
    FP12_BLS12381 g1, g2;
    ...
    BIG_384_29_rcopy(a, Fra_BLS12381);
    BIG_384_29_rcopy(b, Frb_BLS12381);
...
void FP12_BLS12381_pow(FP12_BLS12381 *r, FP12_BLS12381 *a, BIG_384_29 b)
{
    FP12_BLS12381 w, sf;
    BIG_384_29 b1, b3;
    int i, nb, bt;
...
void FP12_BLS12381_pow4(FP12_BLS12381 *p, FP12_BLS12381 *q, BIG_384_29 u[4])
{
    int i, j, k, nb, pb, bt;
    FP12_BLS12381 g[8], r;
    BIG_384_29 t[4], mt;
...
void FP12_BLS12381_toOctet(octet *W, FP12_BLS12381 *g)
{
    ...
    FP4_BLS12381_toBytes(&(W->val[0]),&(g->c));
    FP4_BLS12381_toBytes(&(W->val[4 * MODBYTES_384_29]),&(g->b));
    FP4_BLS12381_toBytes(&(W->val[8 * MODBYTES_384_29]),&(g->a));
}
...
{
    FP4_BLS12381_fromBytes(&(g->c),&(W->val[0]));
    FP4_BLS12381_fromBytes(&(g->b),&(W->val[4 * MODBYTES_384_29]));
    FP4_BLS12381_fromBytes(&(g->a),&(W->val[8 * MODBYTES_384_29]));
}
