...
void FP_BLS12381_nres(FP_BLS12381 *y, BIG_384_29 x)
{
    BIG_384_29 mdls;
    BIG_384_29_rcopy(mdls, Modulus_BLS12381);
...
void FP_BLS12381_redc(BIG_384_29 x, FP_BLS12381 *y)
{
    BIG_384_29_copy(x, y->g);
}

/* reduce a DBIG to a BIG exploiting the special form of the modulus */
void FP_BLS12381_mod(BIG_384_29 r, DBIG_384_29 d)
{
    BIG_384_29 t, b;
    chunk v, tw;
    BIG_384_29_split(t, b, d, MODBITS_BLS12381);
    ...
    if (MConst_BLS12381 < NEXCESS_384_29)
    {
        BIG_384_29_imul(t, t, MConst_BLS12381);
        BIG_384_29_norm(t);
        BIG_384_29_add(r, t, b);
        BIG_384_29_norm(r);
        tw = r[NLEN_384_29 - 1];
        r[NLEN_384_29 - 1] &= TMASK_BLS12381;
        r[0] += MConst_BLS12381 * ((tw >> TBITS_BLS12381));
    }
    else
    {
        v = BIG_384_29_pmul(t, t, MConst_BLS12381);
        BIG_384_29_add(r, t, b);
        BIG_384_29_norm(r);
        tw = r[NLEN_384_29 - 1];
        r[NLEN_384_29 - 1] &= TMASK_BLS12381;
#if CHUNK == 16
        r[1] += muladd_384_29(MConst_BLS12381, ((tw >> TBITS_BLS12381) + (v << (BASEBITS_384_29 - TBITS_BLS12381))), 0, &r[0]);
#else
        r[0] += MConst_BLS12381 * ((tw >> TBITS_BLS12381) + (v << (BASEBITS_384_29 - TBITS_BLS12381)));
#endif
    }
    BIG_384_29_norm(r);
}
...
void FP_BLS12381_mod(BIG_384_29 r, DBIG_384_29 d)
{
    BIG_384_29 t, b;
    chunk carry;
    BIG_384_29_split(t, b, d, MBITS_BLS12381);

    BIG_384_29_add(r, t, b);

    BIG_384_29_dscopy(d, t);
    BIG_384_29_dshl(d, MBITS_BLS12381 / 2);
    ...
    BIG_384_29_norm(r);
    BIG_384_29_shl(t, MBITS_BLS12381 / 2);

    BIG_384_29_add(r, r, t);

    carry = r[NLEN_384_29 - 1] >> TBITS_BLS12381;
...
void FP_BLS12381_nres(FP_BLS12381 *y, BIG_384_29 x)
{
    DBIG_384_29 d;
    BIG_384_29 r;
    BIG_384_29_rcopy(r, R2modp_BLS12381);
...
void FP_BLS12381_mod(BIG_384_29 a, DBIG_384_29 d)
{
    int i;

    for (i = 0; i < NLEN_384_29; i++)
        d[NLEN_384_29 + i] += muladd_384_29(d[i], MConst_BLS12381 - 1, d[i], &d[NLEN_384_29 + i - 1]);
...
void FP_BLS12381_mod(BIG_384_29 a, DBIG_384_29 d)
{
    BIG_384_29 mdls;
    BIG_384_29_rcopy(mdls, Modulus_BLS12381);
    BIG_384_29_monty(a, mdls, MConst_BLS12381, d);
}
...
{
    BIG_384_29 w;
    if (a<0) BIG_384_29_rcopy(w, Modulus_BLS12381);
...
void FP_BLS12381_rcopy(FP_BLS12381 *y, const BIG_384_29 c)
{
    BIG_384_29 b;
...
int FP_BLS12381_islarger(FP_BLS12381 *x)
{
    BIG_384_29 p,fx,sx;
    if (FP_BLS12381_iszilch(x)) return 0;
    BIG_384_29_rcopy(p,Modulus_BLS12381);
    FP_BLS12381_redc(fx,x);
    BIG_384_29_sub(sx,p,fx);  BIG_384_29_norm(sx); 
    return BIG_384_29_comp(fx,sx);
}

void FP_BLS12381_toBytes(char *b,FP_BLS12381 *x)
{
    BIG_384_29 t;
    FP_BLS12381_redc(t, x);
    BIG_384_29_toBytes(b, t);
}

void FP_BLS12381_fromBytes(FP_BLS12381 *x,char *b)
{
    BIG_384_29 t;
    BIG_384_29_fromBytes(t, b);
    FP_BLS12381_nres(x, t);
}
...
void FP_BLS12381_pow(FP_BLS12381 *r, FP_BLS12381 *a, BIG_384_29 b)
{
...
// phase 1
    ...
    n = MODBITS_BLS12381;
#endif
#if MODTYPE_BLS12381==GENERALISED_MERSENNE  // Ed448 ONLY
...
void FP_BLS12381_sqrt(FP_BLS12381 *r, FP_BLS12381 *a, FP_BLS12381 *h)
{
    ...
    BIG_384_29_rcopy(m,ROI_BLS12381);
...
int FP_BLS12381_sign(FP_BLS12381 *x)
{
    ...
    BIG_384_29 m,pm1d2;
    FP_BLS12381 y;
    BIG_384_29_rcopy(pm1d2, Modulus_BLS12381);
