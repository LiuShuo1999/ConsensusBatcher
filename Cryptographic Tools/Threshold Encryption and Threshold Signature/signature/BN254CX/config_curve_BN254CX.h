...
#define CURVETYPE_BN254CX WEIERSTRASS          /**< Define Curve Type */
#define CURVE_A_BN254CX 0            /**< Curve A parameter */
#define PAIRING_FRIENDLY_BN254CX BN_CURVE   /**< Is curve pairing-friendly */
#define CURVE_SECURITY_BN254CX 128     /**< Curve security level in AES bits */
#define HTC_ISO_BN254CX 0            /**< Use Isogenies for Hash to Curve */
...
#define HTC_ISO_G2_BN254CX 0        /**< Use Isogenies for G2 Hash to Curve */
...
#define USE_GS_GT_BN254CX /**< Not patented, so probably OK to always use this */

#define POSITIVEX 0
#define NEGATIVEX 1

#define SEXTIC_TWIST_BN254CX D_TYPE       /**< Sextic Twist M or D type */
#define SIGN_OF_X_BN254CX NEGATIVEX          /**< Sign of curve parameter */ 

#define ATE_BITS_BN254CX 66           /**< Number of Bits in curve parameter */
#define G2_TABLE_BN254CX 76           /**< Size of table for pairing precomputation for fixed G2 */
