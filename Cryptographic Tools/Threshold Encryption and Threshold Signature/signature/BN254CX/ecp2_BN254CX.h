 ...
 */
extern void ECP2_BN254CX_toOctet(octet *S, ECP2_BN254CX *P, bool c);
 ...
 *
	...
	@return 1 if point exists, else 0
 */
extern int ECP2_BN254CX_setx(ECP2_BN254CX *P, FP2_BN254CX *x, int s);
 ...
 */
extern void ECP2_BN254CX_cfp(ECP2_BN254CX *Q);
 ...
 */
extern void ECP2_BN254CX_map2point(ECP2_BN254CX *Q, FP2_BN254CX *x);
 ...
 */
extern void ECP2_BN254CX_hap2point(ECP2_BN254CX *Q, BIG_256_28  x);
 ...
 *
	...
	@return 1 if point exists, else 0
 */
extern int ECP2_BN254CX_generator(ECP2_BN254CX *G);
