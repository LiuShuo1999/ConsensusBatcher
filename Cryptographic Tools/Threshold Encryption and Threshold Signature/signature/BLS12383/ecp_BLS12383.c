...
int ECP_BLS12383_set(ECP_BLS12383 *P, BIG_384_29 x)
{
    //BIG_384_29 m, b;
    FP_BLS12383 rhs;
...
int ECP_BLS12383_get(BIG_384_29 x, ECP_BLS12383 *P)
{
    ECP_BLS12383 W;
...
/* SU=16 */
int ECP_BLS12383_get(BIG_384_29 x, BIG_384_29 y, ECP_BLS12383 *P)
{
    ECP_BLS12383 W;
    ECP_BLS12383_copy(&W, P);
    ECP_BLS12383_affine(&W);
...
/* Set P=(x,{y}) */
/* SU=96 */
int ECP_BLS12383_set(ECP_BLS12383 *P, BIG_384_29 x, BIG_384_29 y)
{
    FP_BLS12383 rhs, y2;
...
/* SU=136 */
int ECP_BLS12383_setx(ECP_BLS12383 *P, BIG_384_29 x, int s)
{
...
{   /* multiply point by curves cofactor */
    ...
    BIG_384_29_rcopy(c, CURVE_Cof_BLS12383);
...
/*
void ECP_BLS12383_hap2point(ECP_BLS12383 *P,BIG_384_29 h)
{
    BIG_384_29 x;
    BIG_384_29_copy(x,h);
...
// Elligator 2
    ...
    //BIG_384_29_zero(a); BIG_384_29_inc(a,CURVE_A_BLS12383); BIG_384_29_norm(a); FP_BLS12383_nres(&A,a);
...
void ECP_BLS12383_mul(ECP_BLS12383 *P,BIG_384_29 e)
{
...
// Set P=e*P 
void ECP_BLS12383_clmul(ECP_BLS12383 *P, BIG_384_29 e, BIG_384_29 maxe)
{
    int max;
    BIG_384_29 cm;
#if CURVETYPE_BLS12383==MONTGOMERY
...
void ECP_BLS12383_muln(ECP_BLS12383 *P,int n,ECP_BLS12383 X[],BIG_384_29 e[])
{
    int i,j,k,nb;
    BIG_384_29 t,mt;
...
void ECP_BLS12383_mul2(ECP_BLS12383 *P, ECP_BLS12383 *Q, BIG_384_29 e, BIG_384_29 f)
{
    BIG_384_29 te, tf, mt;
...
{
    BIG_384_29 x, y;
    BIG_384_29_rcopy(x, CURVE_Gx_BLS12383);
#if CURVETYPE_BLS12383!=MONTGOMERY
    BIG_384_29_rcopy(y, CURVE_Gy_BLS12383);
