...
#ifndef FP12_BLS12383_H
#define FP12_BLS12383_H
...
typedef struct
{
    FP4_BLS12383 a; /**< first part of FP12 */
    FP4_BLS12383 b; /**< second part of FP12 */
    FP4_BLS12383 c; /**< third part of FP12 */
 ...
 */
extern int FP12_BLS12383_equals(FP12_BLS12383 *x, FP12_BLS12383 *y);
 ...
 */
extern void FP12_BLS12383_conj(FP12_BLS12383 *x, FP12_BLS12383 *y);
 ...
 */
extern void FP12_BLS12383_from_FP4(FP12_BLS12383 *x, FP4_BLS12383 *a);
 ...
 */
extern void FP12_BLS12383_from_FP4s(FP12_BLS12383 *x, FP4_BLS12383 *a, FP4_BLS12383* b, FP4_BLS12383 *c);
/**	@brief Fast Squaring of an FP12 in "unitary" form
 *
	@param x FP12 instance, on exit = y^2
	@param y FP4 instance, must be unitary
 */
extern void FP12_BLS12383_usqr(FP12_BLS12383 *x, FP12_BLS12383 *y);
/**	@brief Squaring an FP12
 *
	@param x FP12 instance, on exit = y^2
	@param y FP12 instance
 */
extern void FP12_BLS12383_sqr(FP12_BLS12383 *x, FP12_BLS12383 *y);
 ...
 */
extern void FP12_BLS12383_smul(FP12_BLS12383 *x, FP12_BLS12383 *y);
 ...
 *
	...
	@param y FP12 instance, of special form
 */
extern void FP12_BLS12383_ssmul(FP12_BLS12383 *x, FP12_BLS12383 *y);
 ...
 */
extern void FP12_BLS12383_mul(FP12_BLS12383 *x, FP12_BLS12383 *y);
/**	@brief Inverting an FP12
 *
	@param x FP12 instance, on exit = 1/y
	@param y FP12 instance
 */
extern void FP12_BLS12383_inv(FP12_BLS12383 *x, FP12_BLS12383 *y);
 ...
 *
	...
	@param b BIG number
 */
extern void FP12_BLS12383_pow(FP12_BLS12383 *r, FP12_BLS12383 *x, BIG_384_29 b);
 ...
 */
extern void FP12_BLS12383_pinpow(FP12_BLS12383 *x, int i, int b);
 ...
 */
extern void FP12_BLS12383_compow(FP4_BLS12383 *c, FP12_BLS12383 *x, BIG_384_29 e, BIG_384_29 r);
 ...
 */
extern void FP12_BLS12383_toOctet(octet *S, FP12_BLS12383 *x);
 ...
 */
extern void FP12_BLS12383_fromOctet(FP12_BLS12383 *x, octet *S);
 ...
 */
extern void FP12_BLS12383_trace(FP4_BLS12383 *t, FP12_BLS12383 *x);
 ...
 */
extern void FP12_BLS12383_cmove(FP12_BLS12383 *x, FP12_BLS12383 *y, int s);
