...
void FP12_BLS12383_compow(FP4_BLS12383 *c, FP12_BLS12383 *x, BIG_384_29 e, BIG_384_29 r)
{
    FP12_BLS12383 g1, g2;
    ...
    BIG_384_29_rcopy(a, Fra_BLS12383);
    BIG_384_29_rcopy(b, Frb_BLS12383);
...
void FP12_BLS12383_pow(FP12_BLS12383 *r, FP12_BLS12383 *a, BIG_384_29 b)
{
    FP12_BLS12383 w, sf;
    BIG_384_29 b1, b3;
    int i, nb, bt;
...
void FP12_BLS12383_pow4(FP12_BLS12383 *p, FP12_BLS12383 *q, BIG_384_29 u[4])
{
    int i, j, k, nb, pb, bt;
    FP12_BLS12383 g[8], r;
    BIG_384_29 t[4], mt;
...
void FP12_BLS12383_toOctet(octet *W, FP12_BLS12383 *g)
{
    ...
    FP4_BLS12383_toBytes(&(W->val[4 * MODBYTES_384_29]),&(g->b));
    FP4_BLS12383_toBytes(&(W->val[8 * MODBYTES_384_29]),&(g->a));
}
...
void FP12_BLS12383_fromOctet(FP12_BLS12383 *g, octet *W)
{
    ...
    FP4_BLS12383_fromBytes(&(g->b),&(W->val[4 * MODBYTES_384_29]));
    FP4_BLS12383_fromBytes(&(g->a),&(W->val[8 * MODBYTES_384_29]));
}
