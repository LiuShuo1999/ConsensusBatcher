...
void ECP2_BLS12383_toOctet(octet *W, ECP2_BLS12383 *Q, bool compress)
{
    ...
    if (alt)
    {
        ...
        if (!compress)
        {
            ...
            FP2_BLS12383_toBytes(&(W->val[2*MODBYTES_384_29]), &qy);
        } else {
            W->val[0]|=0x80;
        ...
        {
            W->val[0] = 0x04;
            FP2_BLS12383_toBytes(&(W->val[2 * MODBYTES_384_29+1]), &qy);
...
int ECP2_BLS12383_fromOctet(ECP2_BLS12383 *Q, octet *W)
{
    ...
    if (alt)
    {
        ...
        if ((typ&0x80)==0)
        {
            FP2_BLS12383_fromBytes(&qy,&(W->val[2*MODBYTES_384_29]));
        ...
        if (typ == 0x04)
        {
            FP2_BLS12383_fromBytes(&qy,&(W->val[2 * MODBYTES_384_29+1]));
            if (ECP2_BLS12383_set(Q, &qx, &qy)) return 1;
        } else {
...
void ECP2_BLS12383_rhs(FP2_BLS12383 *rhs, FP2_BLS12383 *x)
{
    ...
    BIG_384_29_rcopy(b, CURVE_B_BLS12383);
...
/* P*=e */
/* SU= 280 */
void ECP2_BLS12383_mul(ECP2_BLS12383 *P, BIG_384_29 e)
{
    /* fixed size windows */
    int i, nb, s, ns;
    BIG_384_29 mt, t;
...
void ECP2_BLS12383_mul4(ECP2_BLS12383 *P, ECP2_BLS12383 Q[4], BIG_384_29 u[4])
{
    int i, j, k, nb, pb, bt;
    ECP2_BLS12383 T[8], W;
    BIG_384_29 t[4], mt;
...
/*
void ECP2_BLS12383_hap2point(ECP2_BLS12383 *Q,BIG_384_29 h)
{
    BIG_384_29 one,hv;
    FP2_BLS12383 X;
    BIG_384_29_one(one);
