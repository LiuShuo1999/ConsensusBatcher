...
#ifndef MPIN256_BLS48286_H
#define MPIN256_BLS48286_H

#include "pair8_BLS48286.h"

/* Field size is assumed to be greater than or equal to group size */

#define PGS_BLS48286 MODBYTES_288_29  /**< MPIN Group Size */
#define PFS_BLS48286 MODBYTES_288_29  /**< MPIN Field Size */
...
//#define PAS_BLS48286 24        /**< MPIN Symmetric Key Size 192 bits  */
//#define HASH_TYPE_MPIN_BLS48286 SHA384   /**< Choose Hash function */
 ...
 */
int MPIN_BLS48286_EXTRACT_PIN(octet *HID, int pin, octet *CS);
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BLS48286_CLIENT_1(octet *HID, csprng *R, octet *x, int pin, octet *T, octet *S, octet *U);
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BLS48286_RANDOM_GENERATE(csprng *R, octet *S);
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BLS48286_CLIENT_2(octet *x, octet *y, octet *V);
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BLS48286_SERVER(octet *HID, octet *y, octet *SS, octet *U, octet *V);
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BLS48286_GET_CLIENT_SECRET(octet *S, octet *HID, octet *CS);
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BLS48286_GET_SERVER_SECRET(octet *S, octet *SS);
#endif
