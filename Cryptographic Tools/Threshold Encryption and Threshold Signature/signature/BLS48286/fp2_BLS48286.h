...
#ifndef FP2_BLS48286_H
#define FP2_BLS48286_H
...
typedef struct
{
    FP_BLS48286 a; /**< real part of FP2 */
    FP_BLS48286 b; /**< imaginary part of FP2 */
} FP2_BLS48286;
 ...
 */
extern int FP2_BLS48286_iszilch(FP2_BLS48286 *x);
 ...
 */
extern int FP2_BLS48286_islarger(FP2_BLS48286 *x);
 ...
 */
extern void FP2_BLS48286_toBytes(char *b,FP2_BLS48286 *x);
 ...
 */
extern void FP2_BLS48286_fromBytes(FP2_BLS48286 *x,char *b);
 ...
 */
extern void FP2_BLS48286_cmove(FP2_BLS48286 *x, FP2_BLS48286 *y, int s);
/**	@brief Tests for FP2 equal to one
 *
	@param x FP2 instance to be tested
	@return 1 if x=1, else returns 0
 */
extern int FP2_BLS48286_isunity(FP2_BLS48286 *x);
 ...
 */
extern int FP2_BLS48286_equals(FP2_BLS48286 *x, FP2_BLS48286 *y);
 ...
 */
extern void FP2_BLS48286_from_FPs(FP2_BLS48286 *x, FP_BLS48286 *a, FP_BLS48286 *b);
 ...
 */
extern void FP2_BLS48286_from_BIGs(FP2_BLS48286 *x, BIG_288_29 a, BIG_288_29 b);
 ...
 */
extern void FP2_BLS48286_from_ints(FP2_BLS48286 *x, int a, int b);
 ...
 *
	...
	@param a FP to form real part of FP2
 */
extern void FP2_BLS48286_from_FP(FP2_BLS48286 *x, FP_BLS48286 *a);
 ...
 */
extern void FP2_BLS48286_rcopy(FP2_BLS48286 *w,const BIG_288_29 a,const BIG_288_29 b);
 ...
 *
	...
	@return "sign" of FP2
 */
extern int FP2_BLS48286_sign(FP2_BLS48286 *x);
 ...
 */
extern void FP2_BLS48286_neg(FP2_BLS48286 *x, FP2_BLS48286 *y);
 ...
 *
	...
	@param y FP2 instance
 */
extern void FP2_BLS48286_conj(FP2_BLS48286 *x, FP2_BLS48286 *y);
 ...
 */
extern void FP2_BLS48286_add(FP2_BLS48286 *x, FP2_BLS48286 *y, FP2_BLS48286 *z);
 ...
 *
	...
	@param z FP2 instance
 */
extern void FP2_BLS48286_sub(FP2_BLS48286 *x, FP2_BLS48286 *y, FP2_BLS48286 *z);
 ...
 *
	...
	@param b FP residue
 */
extern void FP2_BLS48286_pmul(FP2_BLS48286 *x, FP2_BLS48286 *y, FP_BLS48286 *b);
 ...
 *
	...
	@param i an integer
 */
extern void FP2_BLS48286_imul(FP2_BLS48286 *x, FP2_BLS48286 *y, int i);
/**	@brief Squaring an FP2
 *
	@param x FP2 instance, on exit = y^2
	@param y FP2 instance
 */
extern void FP2_BLS48286_sqr(FP2_BLS48286 *x, FP2_BLS48286 *y);
 ...
 *
	...
	@param z FP2 instance
 */
extern void FP2_BLS48286_mul(FP2_BLS48286 *x, FP2_BLS48286 *y, FP2_BLS48286 *z);
/**	@brief Formats and outputs an FP2 to the console
 *
	@param x FP2 instance
 */
extern void FP2_BLS48286_output(FP2_BLS48286 *x);
/**	@brief Formats and outputs an FP2 to the console in raw form (for debugging)
 *
	@param x FP2 instance
 */
extern void FP2_BLS48286_rawoutput(FP2_BLS48286 *x);
 ...
 *
	...
	@param b BIG number
 */
extern void FP2_BLS48286_pow(FP2_BLS48286 *x, FP2_BLS48286 *y, BIG_288_29 b);
 ...
 */
extern int FP2_BLS48286_qr(FP2_BLS48286 *x, FP_BLS48286 *h);
 ...
 *
    ...
    @param h optional input hint
 */
extern void FP2_BLS48286_sqrt(FP2_BLS48286 *x, FP2_BLS48286 *y, FP_BLS48286 *h);
 ...
 */
extern void FP2_BLS48286_times_i(FP2_BLS48286 *x);
/**	@brief Generate random FP2
 *
	@param x random FP2 number
	@param rng random number generator
 */
extern void FP2_BLS48286_rand(FP2_BLS48286 *x, csprng *rng);
#endif
