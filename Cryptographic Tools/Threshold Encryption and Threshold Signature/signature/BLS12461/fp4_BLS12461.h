...
typedef struct
{
    FP2_BLS12461 a; /**< real part of FP4 */
    FP2_BLS12461 b; /**< imaginary part of FP4 */
} FP4_BLS12461;
 ...
 */
extern int FP4_BLS12461_iszilch(FP4_BLS12461 *x);
 ...
 */
extern int FP4_BLS12461_islarger(FP4_BLS12461 *x);
 ...
 */
extern void FP4_BLS12461_toBytes(char *b,FP4_BLS12461 *x);
 ...
 */
extern void FP4_BLS12461_fromBytes(FP4_BLS12461 *x,char *b);
 ...
 */
extern int FP4_BLS12461_isunity(FP4_BLS12461 *x);
 ...
 */
extern int FP4_BLS12461_equals(FP4_BLS12461 *x, FP4_BLS12461 *y);
/**	@brief Tests for FP4 having only a real part and no imaginary part
 *
	@param x FP4 number to be tested
	@return 1 if real, else returns 0
 */
extern int FP4_BLS12461_isreal(FP4_BLS12461 *x);
 ...
 */
extern void FP4_BLS12461_from_FP2s(FP4_BLS12461 *x, FP2_BLS12461 *a, FP2_BLS12461 *b);
 ...
 *
	...
	@param a FP2 to form real part of FP4
 */
extern void FP4_BLS12461_from_FP2(FP4_BLS12461 *x, FP2_BLS12461 *a);
 ...
 */
extern void FP4_BLS12461_from_FP2H(FP4_BLS12461 *x, FP2_BLS12461 *a);
 ...
 */
extern void FP4_BLS12461_from_FP(FP4_BLS12461 *x, FP_BLS12461 *a);
 ...
 */
extern void FP4_BLS12461_copy(FP4_BLS12461 *x, FP4_BLS12461 *y);
/**	@brief Set FP4 to zero
 *
	@param x FP4 instance to be set to zero
 */
extern void FP4_BLS12461_zero(FP4_BLS12461 *x);
/**	@brief Set FP4 to unity
 *
	@param x FP4 instance to be set to one
 */
extern void FP4_BLS12461_one(FP4_BLS12461 *x);
 ...
 *
	...
	@return "sign" of FP4
 */
extern int FP4_BLS12461_sign(FP4_BLS12461 *x);
 ...
 */
extern void FP4_BLS12461_neg(FP4_BLS12461 *x, FP4_BLS12461 *y);
 ...
 *
	...
	@param y FP4 instance
 */
extern void FP4_BLS12461_conj(FP4_BLS12461 *x, FP4_BLS12461 *y);
 ...
 *
	...
	@param y FP4 instance
 */
extern void FP4_BLS12461_nconj(FP4_BLS12461 *x, FP4_BLS12461 *y);
 ...
 */
extern void FP4_BLS12461_add(FP4_BLS12461 *x, FP4_BLS12461 *y, FP4_BLS12461 *z);
 ...
 *
	...
	@param z FP4 instance
 */
extern void FP4_BLS12461_sub(FP4_BLS12461 *x, FP4_BLS12461 *y, FP4_BLS12461 *z);
 ...
 */
extern void FP4_BLS12461_pmul(FP4_BLS12461 *x, FP4_BLS12461 *y, FP2_BLS12461 *a);
 ...
 */
extern void FP4_BLS12461_qmul(FP4_BLS12461 *x, FP4_BLS12461 *y, FP_BLS12461 *a);
 ...
 *
	...
	@param i an integer
 */
extern void FP4_BLS12461_imul(FP4_BLS12461 *x, FP4_BLS12461 *y, int i);
/**	@brief Squaring an FP4
 *
	@param x FP4 instance, on exit = y^2
	@param y FP4 instance
 */
extern void FP4_BLS12461_sqr(FP4_BLS12461 *x, FP4_BLS12461 *y);
 ...
 *
	...
	@param z FP4 instance
 */
extern void FP4_BLS12461_mul(FP4_BLS12461 *x, FP4_BLS12461 *y, FP4_BLS12461 *z);
 ...
 *
	...
	@param b BIG number
 */
extern void FP4_BLS12461_pow(FP4_BLS12461 *x, FP4_BLS12461 *y, BIG_464_28 b);
/**	@brief Raises an FP4 to the power of the internal modulus p, using the Frobenius
 *
	@param x FP4 instance, on exit = x^p
	@param f FP2 precalculated Frobenius constant
 */
extern void FP4_BLS12461_frob(FP4_BLS12461 *x, FP2_BLS12461 *f);
 ...
 *
	...
	@param z FP4 instance
 */
extern void FP4_BLS12461_xtr_A(FP4_BLS12461 *r, FP4_BLS12461 *w, FP4_BLS12461 *x, FP4_BLS12461 *y, FP4_BLS12461 *z);
/**	@brief Calculates the XTR doubling function r=x^2-2*conj(x)
 *
	@param r FP4 instance, on exit = x^2-2*conj(x)
	@param x FP4 instance
 */
extern void FP4_BLS12461_xtr_D(FP4_BLS12461 *r, FP4_BLS12461 *x);
 ...
 *
	...
	@param b BIG number
 */
extern void FP4_BLS12461_xtr_pow(FP4_BLS12461 *r, FP4_BLS12461 *x, BIG_464_28 b);
 ...
 *
	...
	@param b BIG number
 */
extern void FP4_BLS12461_xtr_pow2(FP4_BLS12461 *r, FP4_BLS12461 *c, FP4_BLS12461 *d, FP4_BLS12461 *e, FP4_BLS12461 *f, BIG_464_28 a, BIG_464_28 b);
 ...
 */
extern void FP4_BLS12461_cmove(FP4_BLS12461 *x, FP4_BLS12461 *y, int s);
 ...
 */
extern int  FP4_BLS12461_qr(FP4_BLS12461 *r, FP_BLS12461 *h);
 ...
 *
	...
	@param h optional input hint
 */
extern void  FP4_BLS12461_sqrt(FP4_BLS12461 *r, FP4_BLS12461 *x, FP_BLS12461 *h);
 ...
 *
	...
	@param x FP4 instance
 */
extern void FP4_BLS12461_div_i(FP4_BLS12461 *x);
 ...
 *
	...
	@param x FP4 instance
 */
extern void FP4_BLS12461_div_2i(FP4_BLS12461 *x);
 ...
 *
	...
	@param y FP4 instance
 */
extern void FP4_BLS12461_div2(FP4_BLS12461 *x, FP4_BLS12461 *y);
 ...
 */
extern void FP4_BLS12461_rand(FP4_BLS12461 *x, csprng *rng);
