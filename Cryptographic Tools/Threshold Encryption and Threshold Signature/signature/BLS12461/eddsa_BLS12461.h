...
#ifndef EDDSA_BLS12461_H
#define EDDSA_BLS12461_H
 ...
 */
extern int EDDSA_BLS12461_KEY_PAIR_GENERATE(csprng *R, octet *D, octet *Q);
 ...
 *
	...
	@return 0 or an error code
 */
extern int EDDSA_BLS12461_SIGNATURE(bool ph,octet *D, octet *context,octet *M,octet *SIG);
 ...
 */
extern bool EDDSA_BLS12461_VERIFY(bool ph,octet *Q,octet *context,octet *M,octet *SIG);
#endif