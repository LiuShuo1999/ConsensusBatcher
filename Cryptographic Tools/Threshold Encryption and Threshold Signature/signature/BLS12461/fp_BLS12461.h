...
#ifndef FP_BLS12461_H
#define FP_BLS12461_H
...
typedef struct
{
    BIG_464_28 g;	/**< Big representation of field element */
    sign32 XES;	/**< Excess */
} FP_BLS12461;


/* Field Params - see rom.c */
extern const BIG_464_28 Modulus_BLS12461;	/**< Actual Modulus set in rom_field_yyy.c */
extern const BIG_464_28 ROI_BLS12461;	    /**< Root of unity set in rom_field_yyy.c */
extern const BIG_464_28 R2modp_BLS12461;	/**< Montgomery constant */
extern const BIG_464_28 CRu_BLS12461;       /**< Cube Root of Unity */
extern const BIG_464_28 SQRTm3_BLS12461; /**< Square root of -3 */
extern const BIG_464_28 TWK_BLS12461; /**< Tweak for square roots, pre-calculated from field norm */
extern const chunk MConst_BLS12461;		/**< Constant associated with Modulus - for Montgomery = 1/p mod 2^BASEBITS */


#define MODBITS_BLS12461 MBITS_BLS12461                        /**< Number of bits in Modulus for selected curve */
#define TBITS_BLS12461 (MBITS_BLS12461%BASEBITS_464_28)           /**< Number of active bits in top word */
#define TMASK_BLS12461 (((chunk)1<<TBITS_BLS12461)-1)          /**< Mask for active bits in top word */
#define FEXCESS_BLS12461 (((sign32)1<<MAXXES_BLS12461)-1)	     /**< 2^(BASEBITS*NLEN-MODBITS)-1 - normalised BIG can be multiplied by less than this before reduction */
#define OMASK_BLS12461 (-((chunk)(1)<<TBITS_BLS12461))         /**<  for masking out overflow bits */

//#define BIG_ENDIAN_SIGN_BLS12461 
 ...
 *
	...
	@param a integer
 */
extern void FP_BLS12461_from_int(FP_BLS12461 *x,int a);
 ...
 */
extern int FP_BLS12461_iszilch(FP_BLS12461 *x);
 ...
 */
extern int FP_BLS12461_islarger(FP_BLS12461 *x);
 ...
 */
extern void FP_BLS12461_toBytes(char *b,FP_BLS12461 *x);
 ...
 */
extern void FP_BLS12461_fromBytes(FP_BLS12461 *x,char *b);
 ...
 */
extern int FP_BLS12461_isunity(FP_BLS12461 *x);
 ...
 */
extern void FP_BLS12461_zero(FP_BLS12461 *x);
 ...
 */
extern void FP_BLS12461_copy(FP_BLS12461 *y, FP_BLS12461 *x);
 ...
 */
extern void FP_BLS12461_rcopy(FP_BLS12461 *y, const BIG_464_28 x);
 ...
 */
extern int FP_BLS12461_equals(FP_BLS12461 *x, FP_BLS12461 *y);
 ...
 */
extern void FP_BLS12461_cswap(FP_BLS12461 *x, FP_BLS12461 *y, int s);
 ...
 */
extern int FP_BLS12461_sign(FP_BLS12461 *x);
 ...
 */
extern void FP_BLS12461_mod(BIG_464_28 r, DBIG_464_28 d);

#ifdef FUSED_MODMUL
extern void FP_BLS12461_modmul(BIG_464_28, BIG_464_28, BIG_464_28);
#endif
 ...
 */
extern void FP_BLS12461_mul(FP_BLS12461 *x, FP_BLS12461 *y, FP_BLS12461 *z);
 ...
 */
extern void FP_BLS12461_imul(FP_BLS12461 *x, FP_BLS12461 *y, int i);
 ...
 */
extern void FP_BLS12461_sqr(FP_BLS12461 *x, FP_BLS12461 *y);
 ...
 *
	...
	@param z FP number
 */
extern void FP_BLS12461_add(FP_BLS12461 *x, FP_BLS12461 *y, FP_BLS12461 *z);
 ...
 *
	...
	@param z FP number
 */
extern void FP_BLS12461_sub(FP_BLS12461 *x, FP_BLS12461 *y, FP_BLS12461 *z);
/**	@brief Modular division by 2 of an FP, mod Modulus
 *
	@param x FP number, on exit =y/2 mod Modulus
	@param y FP number
 */
extern void FP_BLS12461_div2(FP_BLS12461 *x, FP_BLS12461 *y);
 ...
 */
extern void FP_BLS12461_pow(FP_BLS12461 *x, FP_BLS12461 *y, BIG_464_28 z);
 ...
 *
	...
	@param x FP number
 */
extern void FP_BLS12461_progen(FP_BLS12461 *r,FP_BLS12461 *x);
 ...
 */
extern void FP_BLS12461_sqrt(FP_BLS12461 *x, FP_BLS12461 *y, FP_BLS12461 *h);
 ...
 */
extern int FP_BLS12461_qr(FP_BLS12461 *x,FP_BLS12461 *h);
 ...
 *
	...
	@return 1 if quadratic residue, else returns 0 if quadratic non-residue
 */
extern int FP_BLS12461_invsqrt(FP_BLS12461 *i,FP_BLS12461 *s,FP_BLS12461 *x);
 ...
 *
	...
	@return 1 if quadratic residue, else returns 0 if quadratic non-residue
 */
extern int FP_BLS12461_tpo(FP_BLS12461 *i, FP_BLS12461 *s);
 ...
 */
extern void FP_BLS12461_inv(FP_BLS12461 *x, FP_BLS12461 *y, FP_BLS12461 *h);
 ...
 */
extern void FP_BLS12461_rand(FP_BLS12461 *x, csprng *rng);
