...
#ifndef FP_BLS48581_H
#define FP_BLS48581_H
...
typedef struct
{
    BIG_584_29 g;	/**< Big representation of field element */
    sign32 XES;	/**< Excess */
} FP_BLS48581;


/* Field Params - see rom.c */
extern const BIG_584_29 Modulus_BLS48581;	/**< Actual Modulus set in rom_field_yyy.c */
extern const BIG_584_29 ROI_BLS48581;	    /**< Root of unity set in rom_field_yyy.c */
extern const BIG_584_29 R2modp_BLS48581;	/**< Montgomery constant */
extern const BIG_584_29 CRu_BLS48581;       /**< Cube Root of Unity */
extern const BIG_584_29 SQRTm3_BLS48581; /**< Square root of -3 */
extern const BIG_584_29 TWK_BLS48581; /**< Tweak for square roots, pre-calculated from field norm */
extern const chunk MConst_BLS48581;		/**< Constant associated with Modulus - for Montgomery = 1/p mod 2^BASEBITS */


#define MODBITS_BLS48581 MBITS_BLS48581                        /**< Number of bits in Modulus for selected curve */
#define TBITS_BLS48581 (MBITS_BLS48581%BASEBITS_584_29)           /**< Number of active bits in top word */
#define TMASK_BLS48581 (((chunk)1<<TBITS_BLS48581)-1)          /**< Mask for active bits in top word */
#define FEXCESS_BLS48581 (((sign32)1<<MAXXES_BLS48581)-1)	     /**< 2^(BASEBITS*NLEN-MODBITS)-1 - normalised BIG can be multiplied by less than this before reduction */
#define OMASK_BLS48581 (-((chunk)(1)<<TBITS_BLS48581))         /**<  for masking out overflow bits */

//#define BIG_ENDIAN_SIGN_BLS48581 
 ...
 *
	...
	@param a integer
 */
extern void FP_BLS48581_from_int(FP_BLS48581 *x,int a);
 ...
 */
extern int FP_BLS48581_iszilch(FP_BLS48581 *x);
 ...
 */
extern int FP_BLS48581_islarger(FP_BLS48581 *x);
 ...
 */
extern void FP_BLS48581_toBytes(char *b,FP_BLS48581 *x);
 ...
 */
extern void FP_BLS48581_fromBytes(FP_BLS48581 *x,char *b);
 ...
 */
extern int FP_BLS48581_isunity(FP_BLS48581 *x);
 ...
 */
extern void FP_BLS48581_zero(FP_BLS48581 *x);
 ...
 */
extern void FP_BLS48581_copy(FP_BLS48581 *y, FP_BLS48581 *x);
 ...
 */
extern void FP_BLS48581_rcopy(FP_BLS48581 *y, const BIG_584_29 x);
 ...
 */
extern int FP_BLS48581_equals(FP_BLS48581 *x, FP_BLS48581 *y);
 ...
 */
extern void FP_BLS48581_cswap(FP_BLS48581 *x, FP_BLS48581 *y, int s);
 ...
 */
extern int FP_BLS48581_sign(FP_BLS48581 *x);
 ...
 */
extern void FP_BLS48581_mod(BIG_584_29 r, DBIG_584_29 d);

#ifdef FUSED_MODMUL
extern void FP_BLS48581_modmul(BIG_584_29, BIG_584_29, BIG_584_29);
#endif
 ...
 */
extern void FP_BLS48581_mul(FP_BLS48581 *x, FP_BLS48581 *y, FP_BLS48581 *z);
 ...
 */
extern void FP_BLS48581_imul(FP_BLS48581 *x, FP_BLS48581 *y, int i);
 ...
 */
extern void FP_BLS48581_sqr(FP_BLS48581 *x, FP_BLS48581 *y);
 ...
 *
	...
	@param z FP number
 */
extern void FP_BLS48581_add(FP_BLS48581 *x, FP_BLS48581 *y, FP_BLS48581 *z);
 ...
 *
	...
	@param z FP number
 */
extern void FP_BLS48581_sub(FP_BLS48581 *x, FP_BLS48581 *y, FP_BLS48581 *z);
/**	@brief Modular division by 2 of an FP, mod Modulus
 *
	@param x FP number, on exit =y/2 mod Modulus
	@param y FP number
 */
extern void FP_BLS48581_div2(FP_BLS48581 *x, FP_BLS48581 *y);
 ...
 */
extern void FP_BLS48581_pow(FP_BLS48581 *x, FP_BLS48581 *y, BIG_584_29 z);
 ...
 *
	...
	@param x FP number
 */
extern void FP_BLS48581_progen(FP_BLS48581 *r,FP_BLS48581 *x);
 ...
 */
extern void FP_BLS48581_sqrt(FP_BLS48581 *x, FP_BLS48581 *y, FP_BLS48581 *h);
 ...
 */
extern int FP_BLS48581_qr(FP_BLS48581 *x,FP_BLS48581 *h);
 ...
 *
	...
	@return 1 if quadratic residue, else returns 0 if quadratic non-residue
 */
extern int FP_BLS48581_invsqrt(FP_BLS48581 *i,FP_BLS48581 *s,FP_BLS48581 *x);
 ...
 *
	...
	@return 1 if quadratic residue, else returns 0 if quadratic non-residue
 */
extern int FP_BLS48581_tpo(FP_BLS48581 *i, FP_BLS48581 *s);
 ...
 */
extern void FP_BLS48581_inv(FP_BLS48581 *x, FP_BLS48581 *y, FP_BLS48581 *h);
 ...
 */
extern void FP_BLS48581_rand(FP_BLS48581 *x, csprng *rng);
