...
#ifndef FP12_BLS12443_H
#define FP12_BLS12443_H
...
typedef struct
{
    FP4_BLS12443 a; /**< first part of FP12 */
    FP4_BLS12443 b; /**< second part of FP12 */
    FP4_BLS12443 c; /**< third part of FP12 */
 ...
 */
extern int FP12_BLS12443_equals(FP12_BLS12443 *x, FP12_BLS12443 *y);
 ...
 */
extern void FP12_BLS12443_conj(FP12_BLS12443 *x, FP12_BLS12443 *y);
 ...
 */
extern void FP12_BLS12443_from_FP4(FP12_BLS12443 *x, FP4_BLS12443 *a);
 ...
 */
extern void FP12_BLS12443_from_FP4s(FP12_BLS12443 *x, FP4_BLS12443 *a, FP4_BLS12443* b, FP4_BLS12443 *c);
/**	@brief Fast Squaring of an FP12 in "unitary" form
 *
	@param x FP12 instance, on exit = y^2
	@param y FP4 instance, must be unitary
 */
extern void FP12_BLS12443_usqr(FP12_BLS12443 *x, FP12_BLS12443 *y);
/**	@brief Squaring an FP12
 *
	@param x FP12 instance, on exit = y^2
	@param y FP12 instance
 */
extern void FP12_BLS12443_sqr(FP12_BLS12443 *x, FP12_BLS12443 *y);
 ...
 */
extern void FP12_BLS12443_smul(FP12_BLS12443 *x, FP12_BLS12443 *y);
 ...
 *
	...
	@param y FP12 instance, of special form
 */
extern void FP12_BLS12443_ssmul(FP12_BLS12443 *x, FP12_BLS12443 *y);
 ...
 */
extern void FP12_BLS12443_mul(FP12_BLS12443 *x, FP12_BLS12443 *y);
/**	@brief Inverting an FP12
 *
	@param x FP12 instance, on exit = 1/y
	@param y FP12 instance
 */
extern void FP12_BLS12443_inv(FP12_BLS12443 *x, FP12_BLS12443 *y);
 ...
 *
	...
	@param b BIG number
 */
extern void FP12_BLS12443_pow(FP12_BLS12443 *r, FP12_BLS12443 *x, BIG_448_29 b);
 ...
 */
extern void FP12_BLS12443_pinpow(FP12_BLS12443 *x, int i, int b);
 ...
 */
extern void FP12_BLS12443_compow(FP4_BLS12443 *c, FP12_BLS12443 *x, BIG_448_29 e, BIG_448_29 r);
 ...
 */
extern void FP12_BLS12443_toOctet(octet *S, FP12_BLS12443 *x);
 ...
 */
extern void FP12_BLS12443_fromOctet(FP12_BLS12443 *x, octet *S);
 ...
 */
extern void FP12_BLS12443_trace(FP4_BLS12443 *t, FP12_BLS12443 *x);
 ...
 */
extern void FP12_BLS12443_cmove(FP12_BLS12443 *x, FP12_BLS12443 *y, int s);
