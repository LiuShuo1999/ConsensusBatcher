...
#ifndef FP4_BLS12443_H
#define FP4_BLS12443_H
...
typedef struct
{
    FP2_BLS12443 a; /**< real part of FP4 */
    FP2_BLS12443 b; /**< imaginary part of FP4 */
} FP4_BLS12443;
 ...
 */
extern int FP4_BLS12443_iszilch(FP4_BLS12443 *x);
 ...
 */
extern int FP4_BLS12443_islarger(FP4_BLS12443 *x);
 ...
 */
extern void FP4_BLS12443_toBytes(char *b,FP4_BLS12443 *x);
 ...
 */
extern void FP4_BLS12443_fromBytes(FP4_BLS12443 *x,char *b);
 ...
 */
extern int FP4_BLS12443_isunity(FP4_BLS12443 *x);
 ...
 */
extern int FP4_BLS12443_equals(FP4_BLS12443 *x, FP4_BLS12443 *y);
/**	@brief Tests for FP4 having only a real part and no imaginary part
 *
	@param x FP4 number to be tested
	@return 1 if real, else returns 0
 */
extern int FP4_BLS12443_isreal(FP4_BLS12443 *x);
 ...
 */
extern void FP4_BLS12443_from_FP2s(FP4_BLS12443 *x, FP2_BLS12443 *a, FP2_BLS12443 *b);
 ...
 *
	...
	@param a FP2 to form real part of FP4
 */
extern void FP4_BLS12443_from_FP2(FP4_BLS12443 *x, FP2_BLS12443 *a);
 ...
 */
extern void FP4_BLS12443_from_FP2H(FP4_BLS12443 *x, FP2_BLS12443 *a);
 ...
 */
extern void FP4_BLS12443_from_FP(FP4_BLS12443 *x, FP_BLS12443 *a);
 ...
 */
extern void FP4_BLS12443_copy(FP4_BLS12443 *x, FP4_BLS12443 *y);
/**	@brief Set FP4 to zero
 *
	@param x FP4 instance to be set to zero
 */
extern void FP4_BLS12443_zero(FP4_BLS12443 *x);
/**	@brief Set FP4 to unity
 *
	@param x FP4 instance to be set to one
 */
extern void FP4_BLS12443_one(FP4_BLS12443 *x);
 ...
 *
	...
	@return "sign" of FP4
 */
extern int FP4_BLS12443_sign(FP4_BLS12443 *x);
 ...
 */
extern void FP4_BLS12443_neg(FP4_BLS12443 *x, FP4_BLS12443 *y);
 ...
 *
	...
	@param y FP4 instance
 */
extern void FP4_BLS12443_conj(FP4_BLS12443 *x, FP4_BLS12443 *y);
 ...
 *
	...
	@param y FP4 instance
 */
extern void FP4_BLS12443_nconj(FP4_BLS12443 *x, FP4_BLS12443 *y);
 ...
 */
extern void FP4_BLS12443_add(FP4_BLS12443 *x, FP4_BLS12443 *y, FP4_BLS12443 *z);
 ...
 *
	...
	@param z FP4 instance
 */
extern void FP4_BLS12443_sub(FP4_BLS12443 *x, FP4_BLS12443 *y, FP4_BLS12443 *z);
 ...
 */
extern void FP4_BLS12443_pmul(FP4_BLS12443 *x, FP4_BLS12443 *y, FP2_BLS12443 *a);
 ...
 */
extern void FP4_BLS12443_qmul(FP4_BLS12443 *x, FP4_BLS12443 *y, FP_BLS12443 *a);
 ...
 *
	...
	@param i an integer
 */
extern void FP4_BLS12443_imul(FP4_BLS12443 *x, FP4_BLS12443 *y, int i);
/**	@brief Squaring an FP4
 *
	@param x FP4 instance, on exit = y^2
	@param y FP4 instance
 */
extern void FP4_BLS12443_sqr(FP4_BLS12443 *x, FP4_BLS12443 *y);
 ...
 *
	...
	@param z FP4 instance
 */
extern void FP4_BLS12443_mul(FP4_BLS12443 *x, FP4_BLS12443 *y, FP4_BLS12443 *z);
 ...
 *
	...
	@param b BIG number
 */
extern void FP4_BLS12443_pow(FP4_BLS12443 *x, FP4_BLS12443 *y, BIG_448_29 b);
/**	@brief Raises an FP4 to the power of the internal modulus p, using the Frobenius
 *
	@param x FP4 instance, on exit = x^p
	@param f FP2 precalculated Frobenius constant
 */
extern void FP4_BLS12443_frob(FP4_BLS12443 *x, FP2_BLS12443 *f);
 ...
 *
	...
	@param z FP4 instance
 */
extern void FP4_BLS12443_xtr_A(FP4_BLS12443 *r, FP4_BLS12443 *w, FP4_BLS12443 *x, FP4_BLS12443 *y, FP4_BLS12443 *z);
/**	@brief Calculates the XTR doubling function r=x^2-2*conj(x)
 *
	@param r FP4 instance, on exit = x^2-2*conj(x)
	@param x FP4 instance
 */
extern void FP4_BLS12443_xtr_D(FP4_BLS12443 *r, FP4_BLS12443 *x);
 ...
 *
	...
	@param b BIG number
 */
extern void FP4_BLS12443_xtr_pow(FP4_BLS12443 *r, FP4_BLS12443 *x, BIG_448_29 b);
 ...
 *
	...
	@param b BIG number
 */
extern void FP4_BLS12443_xtr_pow2(FP4_BLS12443 *r, FP4_BLS12443 *c, FP4_BLS12443 *d, FP4_BLS12443 *e, FP4_BLS12443 *f, BIG_448_29 a, BIG_448_29 b);
 ...
 */
extern void FP4_BLS12443_cmove(FP4_BLS12443 *x, FP4_BLS12443 *y, int s);
 ...
 */
extern int  FP4_BLS12443_qr(FP4_BLS12443 *r, FP_BLS12443 *h);
 ...
 *
	...
	@param h optional input hint
 */
extern void  FP4_BLS12443_sqrt(FP4_BLS12443 *r, FP4_BLS12443 *x, FP_BLS12443 *h);
 ...
 *
	...
	@param x FP4 instance
 */
extern void FP4_BLS12443_div_i(FP4_BLS12443 *x);
 ...
 *
	...
	@param x FP4 instance
 */
extern void FP4_BLS12443_div_2i(FP4_BLS12443 *x);
 ...
 *
	...
	@param y FP4 instance
 */
extern void FP4_BLS12443_div2(FP4_BLS12443 *x, FP4_BLS12443 *y);
 ...
 */
extern void FP4_BLS12443_rand(FP4_BLS12443 *x, csprng *rng);
