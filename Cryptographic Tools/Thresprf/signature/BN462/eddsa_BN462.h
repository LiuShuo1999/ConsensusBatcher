...
#ifndef EDDSA_BN462_H
#define EDDSA_BN462_H
 ...
 */
extern int EDDSA_BN462_KEY_PAIR_GENERATE(csprng *R, octet *D, octet *Q);
 ...
 *
	...
	@return 0 or an error code
 */
extern int EDDSA_BN462_SIGNATURE(bool ph,octet *D, octet *context,octet *M,octet *SIG);
 ...
 */
extern bool EDDSA_BN462_VERIFY(bool ph,octet *Q,octet *context,octet *M,octet *SIG);
#endif