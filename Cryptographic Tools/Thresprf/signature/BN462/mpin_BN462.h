...
#define PGS_BN462 MODBYTES_464_28  /**< MPIN Group Size */
#define PFS_BN462 MODBYTES_464_28  /**< MPIN Field Size */
...
//#define PAS_BN462 16        /**< MPIN Symmetric Key Size 128 bits */
//#define HASH_TYPE_MPIN_BN462 SHA256   /**< Choose Hash function */
 ...
 */
int MPIN_BN462_EXTRACT_PIN(octet *HID, int pin, octet *CS);
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BN462_CLIENT_1(octet *HID, csprng *R, octet *x, int pin, octet *T, octet *S, octet *U);
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BN462_RANDOM_GENERATE(csprng *R, octet *S);
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BN462_CLIENT_2(octet *x, octet *y, octet *V);
...
/**	@brief Perform final pass on the server side of the M-Pin protocol
	...
	@return 0 or an error code
 */
int MPIN_BN462_SERVER(octet *HID, octet *y, octet *SS, octet *U, octet *V);
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BN462_GET_CLIENT_SECRET(octet *S, octet *HID, octet *CS);
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BN462_GET_SERVER_SECRET(octet *S, octet *SS);
