...
extern const BIG_464_28 Modulus_BN462;	/**< Actual Modulus set in rom_field_yyy.c */
extern const BIG_464_28 ROI_BN462;	    /**< Root of unity set in rom_field_yyy.c */
extern const BIG_464_28 R2modp_BN462;	/**< Montgomery constant */
extern const BIG_464_28 CRu_BN462;       /**< Cube Root of Unity */
extern const BIG_464_28 SQRTm3_BN462; /**< Square root of -3 */
extern const BIG_464_28 TWK_BN462; /**< Tweak for square roots, pre-calculated from field norm */
...
#define TBITS_BN462 (MBITS_BN462%BASEBITS_464_28)           /**< Number of active bits in top word */
 ...
 */
extern void FP_BN462_rcopy(FP_BN462 *y, const BIG_464_28 x);
 ...
 *
	...
	@param y FP result
 */
extern void FP_BN462_nres(FP_BN462 *y, BIG_464_28 x);
/**	@brief Converts from residue form back to BIG integer form
 *
	@param y FP number to be converted to BIG
	@param x BIG result
 */
extern void FP_BN462_redc(BIG_464_28 x, FP_BN462 *y);
 ...
 */
extern void FP_BN462_mod(BIG_464_28 r, DBIG_464_28 d);

#ifdef FUSED_MODMUL
extern void FP_BN462_modmul(BIG_464_28, BIG_464_28, BIG_464_28);
#endif
 ...
 */
extern void FP_BN462_pow(FP_BN462 *x, FP_BN462 *y, BIG_464_28 z);
