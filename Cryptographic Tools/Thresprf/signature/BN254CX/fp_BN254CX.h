...
extern const BIG_256_28 Modulus_BN254CX;	/**< Actual Modulus set in rom_field_yyy.c */
extern const BIG_256_28 ROI_BN254CX;	    /**< Root of unity set in rom_field_yyy.c */
extern const BIG_256_28 R2modp_BN254CX;	/**< Montgomery constant */
extern const BIG_256_28 CRu_BN254CX;       /**< Cube Root of Unity */
extern const BIG_256_28 SQRTm3_BN254CX; /**< Square root of -3 */
extern const BIG_256_28 TWK_BN254CX; /**< Tweak for square roots, pre-calculated from field norm */
...
#define TBITS_BN254CX (MBITS_BN254CX%BASEBITS_256_28)           /**< Number of active bits in top word */
#define TMASK_BN254CX (((chunk)1<<TBITS_BN254CX)-1)          /**< Mask for active bits in top word */
#define FEXCESS_BN254CX (((sign32)1<<MAXXES_BN254CX)-1)	     /**< 2^(BASEBITS*NLEN-MODBITS)-1 - normalised BIG can be multiplied by less than this before reduction */
#define OMASK_BN254CX (-((chunk)(1)<<TBITS_BN254CX))         /**<  for masking out overflow bits */

//#define BIG_ENDIAN_SIGN_BN254CX 
 ...
 *
	...
	@param a integer
 */
extern void FP_BN254CX_from_int(FP_BN254CX *x,int a);
 ...
 */
extern int FP_BN254CX_islarger(FP_BN254CX *x);
 ...
 */
extern void FP_BN254CX_toBytes(char *b,FP_BN254CX *x);
 ...
 */
extern void FP_BN254CX_fromBytes(FP_BN254CX *x,char *b);
 ...
 */
extern int FP_BN254CX_isunity(FP_BN254CX *x);
 ...
 */
extern void FP_BN254CX_rcopy(FP_BN254CX *y, const BIG_256_28 x);
 ...
 *
	...
	@param y FP result
 */
extern void FP_BN254CX_nres(FP_BN254CX *y, BIG_256_28 x);
/**	@brief Converts from residue form back to BIG integer form
 *
	@param y FP number to be converted to BIG
	@param x BIG result
 */
extern void FP_BN254CX_redc(BIG_256_28 x, FP_BN254CX *y);
 ...
 */
extern int FP_BN254CX_sign(FP_BN254CX *x);
 ...
 */
extern void FP_BN254CX_mod(BIG_256_28 r, DBIG_256_28 d);

#ifdef FUSED_MODMUL
extern void FP_BN254CX_modmul(BIG_256_28, BIG_256_28, BIG_256_28);
#endif
 ...
 */
extern void FP_BN254CX_pow(FP_BN254CX *x, FP_BN254CX *y, BIG_256_28 z);
 ...
 *
	...
	@param x FP number
 */
extern void FP_BN254CX_progen(FP_BN254CX *r,FP_BN254CX *x);
 ...
 */
extern void FP_BN254CX_sqrt(FP_BN254CX *x, FP_BN254CX *y, FP_BN254CX *h);
 ...
 */
extern int FP_BN254CX_qr(FP_BN254CX *x,FP_BN254CX *h);
 ...
 *
	...
	@return 1 if quadratic residue, else returns 0 if quadratic non-residue
 */
extern int FP_BN254CX_invsqrt(FP_BN254CX *i,FP_BN254CX *s,FP_BN254CX *x);
 ...
 *
	...
	@return 1 if quadratic residue, else returns 0 if quadratic non-residue
 */
extern int FP_BN254CX_tpo(FP_BN254CX *i, FP_BN254CX *s);
 ...
 */
extern void FP_BN254CX_inv(FP_BN254CX *x, FP_BN254CX *y, FP_BN254CX *h);
 ...
 */
extern void FP_BN254CX_rand(FP_BN254CX *x, csprng *rng);
