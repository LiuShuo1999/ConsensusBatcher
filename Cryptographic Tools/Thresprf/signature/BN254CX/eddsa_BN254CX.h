...
#ifndef EDDSA_BN254CX_H
#define EDDSA_BN254CX_H
 ...
 */
extern int EDDSA_BN254CX_KEY_PAIR_GENERATE(csprng *R, octet *D, octet *Q);
 ...
 *
	...
	@return 0 or an error code
 */
extern int EDDSA_BN254CX_SIGNATURE(bool ph,octet *D, octet *context,octet *M,octet *SIG);
 ...
 */
extern bool EDDSA_BN254CX_VERIFY(bool ph,octet *Q,octet *context,octet *M,octet *SIG);
#endif