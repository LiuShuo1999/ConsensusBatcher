...
void FP2_BLS12383_toBytes(char *b,FP2_BLS12383 *x)
{
    ...
    FP_BLS12383_toBytes(&b[MODBYTES_384_29],&(x->a));
}

void FP2_BLS12383_fromBytes(FP2_BLS12383 *x,char *b)
{
    FP_BLS12383_fromBytes(&(x->b),b);
    FP_BLS12383_fromBytes(&(x->a),&b[MODBYTES_384_29]);
}
...
/* SU= 16 */
void FP2_BLS12383_from_BIGs(FP2_BLS12383 *w, BIG_384_29 x, BIG_384_29 y)
{
...
/* Create FP2 from BIG */
/* SU= 8 */
void FP2_BLS12383_from_BIG(FP2_BLS12383 *w, BIG_384_29 x)
{
    FP_BLS12383_nres(&(w->a), x);
    FP_BLS12383_zero(&(w->b));
}
...
void FP2_BLS12383_rcopy(FP2_BLS12383 *w,const BIG_384_29 a,const BIG_384_29 b)
{
...
/* SU= 208 */
/*
void FP2_BLS12383_pow(FP2_BLS12383 *r, FP2_BLS12383* a, BIG_384_29 b)
{
    FP2_BLS12383 w;
    FP_BLS12383 one;
    BIG_384_29 z, zilch;
