...
extern const BIG_384_29 Modulus_BLS12383;	/**< Actual Modulus set in rom_field_yyy.c */
extern const BIG_384_29 ROI_BLS12383;	    /**< Root of unity set in rom_field_yyy.c */
extern const BIG_384_29 R2modp_BLS12383;	/**< Montgomery constant */
extern const BIG_384_29 CRu_BLS12383;       /**< Cube Root of Unity */
extern const BIG_384_29 SQRTm3_BLS12383; /**< Square root of -3 */
extern const BIG_384_29 TWK_BLS12383; /**< Tweak for square roots, pre-calculated from field norm */
...
#define TBITS_BLS12383 (MBITS_BLS12383%BASEBITS_384_29)           /**< Number of active bits in top word */
 ...
 */
extern void FP_BLS12383_rcopy(FP_BLS12383 *y, const BIG_384_29 x);
 ...
 *
	...
	@param y FP result
 */
extern void FP_BLS12383_nres(FP_BLS12383 *y, BIG_384_29 x);
/**	@brief Converts from residue form back to BIG integer form
 *
	@param y FP number to be converted to BIG
	@param x BIG result
 */
extern void FP_BLS12383_redc(BIG_384_29 x, FP_BLS12383 *y);
 ...
 */
extern void FP_BLS12383_mod(BIG_384_29 r, DBIG_384_29 d);

#ifdef FUSED_MODMUL
extern void FP_BLS12383_modmul(BIG_384_29, BIG_384_29, BIG_384_29);
#endif
 ...
 */
extern void FP_BLS12383_pow(FP_BLS12383 *x, FP_BLS12383 *y, BIG_384_29 z);
