...
void FP4_BLS12383_toBytes(char *b,FP4_BLS12383 *x)
{
    ...
    FP2_BLS12383_toBytes(&b[2*MODBYTES_384_29],&(x->a));
}

void FP4_BLS12383_fromBytes(FP4_BLS12383 *x,char *b)
{
    FP2_BLS12383_fromBytes(&(x->b),b);
    FP2_BLS12383_fromBytes(&(x->a),&b[2*MODBYTES_384_29]);
}
...
/* SU= 240 */
/*
void FP4_BLS12383_pow(FP4_BLS12383 *r, FP4_BLS12383* a, BIG_384_29 b)
{
    FP4_BLS12383 w;
    BIG_384_29 z, zilch;
    int bt;
...
void FP4_BLS12383_xtr_pow(FP4_BLS12383 *r, FP4_BLS12383 *x, BIG_384_29 n)
{
    int i, par, nb;
    BIG_384_29 v;
    FP2_BLS12383 w;
...
void FP4_BLS12383_xtr_pow2(FP4_BLS12383 *r, FP4_BLS12383 *ck, FP4_BLS12383 *cl, FP4_BLS12383 *ckml, FP4_BLS12383 *ckm2l, BIG_384_29 a, BIG_384_29 b)
{
    int i, f2;
    BIG_384_29 d, e, w;
