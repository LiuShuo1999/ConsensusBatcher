...
#ifndef FP4_BLS48556_H
#define FP4_BLS48556_H
...
typedef struct
{
    FP2_BLS48556 a; /**< real part of FP4 */
    FP2_BLS48556 b; /**< imaginary part of FP4 */
} FP4_BLS48556;
 ...
 */
extern int FP4_BLS48556_iszilch(FP4_BLS48556 *x);
 ...
 */
extern int FP4_BLS48556_islarger(FP4_BLS48556 *x);
 ...
 */
extern void FP4_BLS48556_toBytes(char *b,FP4_BLS48556 *x);
 ...
 */
extern void FP4_BLS48556_fromBytes(FP4_BLS48556 *x,char *b);
 ...
 */
extern int FP4_BLS48556_isunity(FP4_BLS48556 *x);
 ...
 */
extern int FP4_BLS48556_equals(FP4_BLS48556 *x, FP4_BLS48556 *y);
/**	@brief Tests for FP4 having only a real part and no imaginary part
 *
	@param x FP4 number to be tested
	@return 1 if real, else returns 0
 */
extern int FP4_BLS48556_isreal(FP4_BLS48556 *x);
 ...
 */
extern void FP4_BLS48556_from_FP2s(FP4_BLS48556 *x, FP2_BLS48556 *a, FP2_BLS48556 *b);
 ...
 *
	...
	@param a FP2 to form real part of FP4
 */
extern void FP4_BLS48556_from_FP2(FP4_BLS48556 *x, FP2_BLS48556 *a);
 ...
 */
extern void FP4_BLS48556_from_FP2H(FP4_BLS48556 *x, FP2_BLS48556 *a);
 ...
 */
extern void FP4_BLS48556_from_FP(FP4_BLS48556 *x, FP_BLS48556 *a);
 ...
 */
extern void FP4_BLS48556_copy(FP4_BLS48556 *x, FP4_BLS48556 *y);
/**	@brief Set FP4 to zero
 *
	@param x FP4 instance to be set to zero
 */
extern void FP4_BLS48556_zero(FP4_BLS48556 *x);
/**	@brief Set FP4 to unity
 *
	@param x FP4 instance to be set to one
 */
extern void FP4_BLS48556_one(FP4_BLS48556 *x);
 ...
 *
	...
	@return "sign" of FP4
 */
extern int FP4_BLS48556_sign(FP4_BLS48556 *x);
 ...
 */
extern void FP4_BLS48556_neg(FP4_BLS48556 *x, FP4_BLS48556 *y);
 ...
 *
	...
	@param y FP4 instance
 */
extern void FP4_BLS48556_conj(FP4_BLS48556 *x, FP4_BLS48556 *y);
 ...
 *
	...
	@param y FP4 instance
 */
extern void FP4_BLS48556_nconj(FP4_BLS48556 *x, FP4_BLS48556 *y);
 ...
 */
extern void FP4_BLS48556_add(FP4_BLS48556 *x, FP4_BLS48556 *y, FP4_BLS48556 *z);
 ...
 *
	...
	@param z FP4 instance
 */
extern void FP4_BLS48556_sub(FP4_BLS48556 *x, FP4_BLS48556 *y, FP4_BLS48556 *z);
 ...
 */
extern void FP4_BLS48556_pmul(FP4_BLS48556 *x, FP4_BLS48556 *y, FP2_BLS48556 *a);
 ...
 */
extern void FP4_BLS48556_qmul(FP4_BLS48556 *x, FP4_BLS48556 *y, FP_BLS48556 *a);
 ...
 *
	...
	@param i an integer
 */
extern void FP4_BLS48556_imul(FP4_BLS48556 *x, FP4_BLS48556 *y, int i);
/**	@brief Squaring an FP4
 *
	@param x FP4 instance, on exit = y^2
	@param y FP4 instance
 */
extern void FP4_BLS48556_sqr(FP4_BLS48556 *x, FP4_BLS48556 *y);
 ...
 *
	...
	@param z FP4 instance
 */
extern void FP4_BLS48556_mul(FP4_BLS48556 *x, FP4_BLS48556 *y, FP4_BLS48556 *z);
 ...
 *
	...
	@param b BIG number
 */
extern void FP4_BLS48556_pow(FP4_BLS48556 *x, FP4_BLS48556 *y, BIG_560_29 b);
/**	@brief Raises an FP4 to the power of the internal modulus p, using the Frobenius
 *
	@param x FP4 instance, on exit = x^p
	@param f FP2 precalculated Frobenius constant
 */
extern void FP4_BLS48556_frob(FP4_BLS48556 *x, FP2_BLS48556 *f);
 ...
 *
	...
	@param z FP4 instance
 */
extern void FP4_BLS48556_xtr_A(FP4_BLS48556 *r, FP4_BLS48556 *w, FP4_BLS48556 *x, FP4_BLS48556 *y, FP4_BLS48556 *z);
/**	@brief Calculates the XTR doubling function r=x^2-2*conj(x)
 *
	@param r FP4 instance, on exit = x^2-2*conj(x)
	@param x FP4 instance
 */
extern void FP4_BLS48556_xtr_D(FP4_BLS48556 *r, FP4_BLS48556 *x);
 ...
 *
	...
	@param b BIG number
 */
extern void FP4_BLS48556_xtr_pow(FP4_BLS48556 *r, FP4_BLS48556 *x, BIG_560_29 b);
 ...
 *
	...
	@param b BIG number
 */
extern void FP4_BLS48556_xtr_pow2(FP4_BLS48556 *r, FP4_BLS48556 *c, FP4_BLS48556 *d, FP4_BLS48556 *e, FP4_BLS48556 *f, BIG_560_29 a, BIG_560_29 b);
 ...
 */
extern void FP4_BLS48556_cmove(FP4_BLS48556 *x, FP4_BLS48556 *y, int s);
 ...
 */
extern int  FP4_BLS48556_qr(FP4_BLS48556 *r, FP_BLS48556 *h);
 ...
 *
	...
	@param h optional input hint
 */
extern void  FP4_BLS48556_sqrt(FP4_BLS48556 *r, FP4_BLS48556 *x, FP_BLS48556 *h);
 ...
 *
	...
	@param x FP4 instance
 */
extern void FP4_BLS48556_div_i(FP4_BLS48556 *x);
 ...
 *
	...
	@param x FP4 instance
 */
extern void FP4_BLS48556_div_2i(FP4_BLS48556 *x);
 ...
 *
	...
	@param y FP4 instance
 */
extern void FP4_BLS48556_div2(FP4_BLS48556 *x, FP4_BLS48556 *y);
 ...
 */
extern void FP4_BLS48556_rand(FP4_BLS48556 *x, csprng *rng);
