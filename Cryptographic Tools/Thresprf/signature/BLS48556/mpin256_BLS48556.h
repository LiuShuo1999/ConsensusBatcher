...
#ifndef MPIN256_BLS48556_H
#define MPIN256_BLS48556_H

#include "pair8_BLS48556.h"

/* Field size is assumed to be greater than or equal to group size */

#define PGS_BLS48556 MODBYTES_560_29  /**< MPIN Group Size */
#define PFS_BLS48556 MODBYTES_560_29  /**< MPIN Field Size */
...
//#define PAS_BLS48556 24        /**< MPIN Symmetric Key Size 192 bits  */
//#define HASH_TYPE_MPIN_BLS48556 SHA384   /**< Choose Hash function */
 ...
 */
int MPIN_BLS48556_EXTRACT_PIN(octet *HID, int pin, octet *CS);
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BLS48556_CLIENT_1(octet *HID, csprng *R, octet *x, int pin, octet *T, octet *S, octet *U);
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BLS48556_RANDOM_GENERATE(csprng *R, octet *S);
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BLS48556_CLIENT_2(octet *x, octet *y, octet *V);
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BLS48556_SERVER(octet *HID, octet *y, octet *SS, octet *U, octet *V);
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BLS48556_GET_CLIENT_SECRET(octet *S, octet *HID, octet *CS);
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BLS48556_GET_SERVER_SECRET(octet *S, octet *SS);
#endif
