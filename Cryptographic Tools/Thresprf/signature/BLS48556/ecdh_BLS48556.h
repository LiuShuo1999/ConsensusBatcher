...
#ifndef ECDH_BLS48556_H
#define ECDH_BLS48556_H
...
//#define EAS_BLS48556 16 /**< Symmetric Key size - 128 bits */
//#define HASH_TYPE_ECC_BLS48556 SHA512  /**< Hash type */

/*** END OF USER CONFIGURABLE SECTION ***/

#define EGS_BLS48556 MODBYTES_560_29  /**< ECC Group Size in bytes */
#define EFS_BLS48556 MODBYTES_560_29  /**< ECC Field Size in bytes */
...
*/
extern int ECP_BLS48556_IN_RANGE(octet *s);
 ...
 */
extern int  ECP_BLS48556_KEY_PAIR_GENERATE(csprng *R, octet *s, octet *W);
 ...
 */
extern int  ECP_BLS48556_PUBLIC_KEY_VALIDATE(octet *W);
 ...
 *
	...
	@return 0 or an error code
 */
extern int ECP_BLS48556_SVDP_DH(octet *s, octet *W, octet *K, int type);
 ...
 */
extern void ECP_BLS48556_ECIES_ENCRYPT(int h, octet *P1, octet *P2, csprng *R, octet *W, octet *M, int len, octet *V, octet *C, octet *T);
 ...
 */
extern int ECP_BLS48556_ECIES_DECRYPT(int h, octet *P1, octet *P2, octet *V, octet *C, octet *T, octet *U, octet *M);
 ...
 */
extern int ECP_BLS48556_SP_DSA(int h, csprng *R, octet *k, octet *s, octet *M, octet *c, octet *d);
 ...
 *
	...
	@return 0 or an error code
 */
extern int ECP_BLS48556_VP_DSA(int h, octet *W, octet *M, octet *c, octet *d);
/*#endif*/
