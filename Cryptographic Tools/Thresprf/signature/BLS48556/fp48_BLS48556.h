...
typedef struct
{
    FP16_BLS48556 a; /**< first part of FP12 */
    FP16_BLS48556 b; /**< second part of FP12 */
    FP16_BLS48556 c; /**< third part of FP12 */
 ...
 */
extern int FP48_BLS48556_equals(FP48_BLS48556 *x, FP48_BLS48556 *y);
 ...
 */
extern void FP48_BLS48556_conj(FP48_BLS48556 *x, FP48_BLS48556 *y);
 ...
 */
extern void FP48_BLS48556_from_FP16(FP48_BLS48556 *x, FP16_BLS48556 *a);
 ...
 */
extern void FP48_BLS48556_from_FP16s(FP48_BLS48556 *x, FP16_BLS48556 *a, FP16_BLS48556* b, FP16_BLS48556 *c);
/**	@brief Fast Squaring of an FP48 in "unitary" form
 *
	@param x FP48 instance, on exit = y^2
	@param y FP16 instance, must be unitary
 */
extern void FP48_BLS48556_usqr(FP48_BLS48556 *x, FP48_BLS48556 *y);
/**	@brief Squaring an FP48
 *
	@param x FP48 instance, on exit = y^2
	@param y FP48 instance
 */
extern void FP48_BLS48556_sqr(FP48_BLS48556 *x, FP48_BLS48556 *y);
 ...
 */
extern void FP48_BLS48556_smul(FP48_BLS48556 *x, FP48_BLS48556 *y);
 ...
 *
	...
	@param y FP48 instance, of special form
 */
extern void FP48_BLS48556_ssmul(FP48_BLS48556 *x, FP48_BLS48556 *y);
/**	@brief Full unconditional Multiplication of two FP24s
 *
	@param x FP48 instance, on exit = x*y
	@param y FP48 instance, the multiplier
 */
extern void FP48_BLS48556_mul(FP48_BLS48556 *x, FP48_BLS48556 *y);
/**	@brief Inverting an FP48
 *
	@param x FP48 instance, on exit = 1/y
	@param y FP48 instance
 */
extern void FP48_BLS48556_inv(FP48_BLS48556 *x, FP48_BLS48556 *y);
 ...
 *
	...
	@param b BIG number
 */
extern void FP48_BLS48556_pow(FP48_BLS48556 *r, FP48_BLS48556 *x, BIG_560_29 b);
 ...
 */
extern void FP48_BLS48556_pinpow(FP48_BLS48556 *x, int i, int b);

/**	@brief Raises an FP48 instance x to a BIG_560_29 power, compressed to FP16
 *
 ...
 */
extern void FP48_BLS48556_compow(FP16_BLS48556 *c, FP48_BLS48556 *x, BIG_560_29 e, BIG_560_29 r);
 ...
 */
extern void FP48_BLS48556_pow16(FP48_BLS48556 *r, FP48_BLS48556 *x, BIG_560_29 *b);
 ...
 */
extern void FP48_BLS48556_toOctet(octet *S, FP48_BLS48556 *x);
 ...
 */
extern void FP48_BLS48556_fromOctet(FP48_BLS48556 *x, octet *S);
 ...
 */
extern void FP48_BLS48556_trace(FP16_BLS48556 *t, FP48_BLS48556 *x);
 ...
 */
extern void FP48_BLS48556_cmove(FP48_BLS48556 *x, FP48_BLS48556 *y, int s);
