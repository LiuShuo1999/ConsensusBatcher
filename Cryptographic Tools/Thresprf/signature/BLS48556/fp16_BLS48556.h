...
#ifndef FP16_BLS48556_H
#define FP16_BLS48556_H
...
typedef struct
{
    FP8_BLS48556 a; /**< real part of FP16 */
    FP8_BLS48556 b; /**< imaginary part of FP16 */
} FP16_BLS48556;
 ...
 */
extern int FP16_BLS48556_iszilch(FP16_BLS48556 *x);
 ...
 */
extern void FP16_BLS48556_toBytes(char *b,FP16_BLS48556 *x);
/**	@brief Serialize out FP16  
 *
	@param x FP16 number to be serialized
    @param b buffer for input
 */
extern void FP16_BLS48556_fromBytes(FP16_BLS48556 *x,char *b);
 ...
 */
extern int FP16_BLS48556_isunity(FP16_BLS48556 *x);
 ...
 */
extern int FP16_BLS48556_equals(FP16_BLS48556 *x, FP16_BLS48556 *y);
/**	@brief Tests for FP16 having only a real part and no imaginary part
 *
	@param x FP16 number to be tested
	@return 1 if real, else returns 0
 */
extern int FP16_BLS48556_isreal(FP16_BLS48556 *x);
 ...
 */
extern void FP16_BLS48556_from_FP8s(FP16_BLS48556 *x, FP8_BLS48556 *a, FP8_BLS48556 *b);
 ...
 *
	...
	@param a FP8 to form real part of FP16
 */
extern void FP16_BLS48556_from_FP8(FP16_BLS48556 *x, FP8_BLS48556 *a);
 ...
 */
extern void FP16_BLS48556_from_FP8H(FP16_BLS48556 *x, FP8_BLS48556 *a);
 ...
 */
extern void FP16_BLS48556_copy(FP16_BLS48556 *x, FP16_BLS48556 *y);
/**	@brief Set FP16 to zero
 *
	@param x FP16 instance to be set to zero
 */
extern void FP16_BLS48556_zero(FP16_BLS48556 *x);
/**	@brief Set FP16 to unity
 *
	@param x FP16 instance to be set to one
 */
extern void FP16_BLS48556_one(FP16_BLS48556 *x);
/**	@brief Negation of FP16
 *
	@param x FP16 instance, on exit = -y
	@param y FP16 instance
 */
extern void FP16_BLS48556_neg(FP16_BLS48556 *x, FP16_BLS48556 *y);
 ...
 *
	...
	@param y FP16 instance
 */
extern void FP16_BLS48556_conj(FP16_BLS48556 *x, FP16_BLS48556 *y);
 ...
 *
	...
	@param y FP16 instance
 */
extern void FP16_BLS48556_nconj(FP16_BLS48556 *x, FP16_BLS48556 *y);
 ...
 */
extern void FP16_BLS48556_add(FP16_BLS48556 *x, FP16_BLS48556 *y, FP16_BLS48556 *z);
 ...
 *
	...
	@param z FP16 instance
 */
extern void FP16_BLS48556_sub(FP16_BLS48556 *x, FP16_BLS48556 *y, FP16_BLS48556 *z);
 ...
 */
extern void FP16_BLS48556_pmul(FP16_BLS48556 *x, FP16_BLS48556 *y, FP8_BLS48556 *a);
 ...
 */
extern void FP16_BLS48556_qmul(FP16_BLS48556 *x, FP16_BLS48556 *y, FP2_BLS48556 *a);
 ...
 */
extern void FP16_BLS48556_tmul(FP16_BLS48556 *x, FP16_BLS48556 *y, FP_BLS48556 *a);
 ...
 *
	...
	@param i an integer
 */
extern void FP16_BLS48556_imul(FP16_BLS48556 *x, FP16_BLS48556 *y, int i);
/**	@brief Squaring an FP16
 *
	@param x FP16 instance, on exit = y^2
	@param y FP16 instance
 */
extern void FP16_BLS48556_sqr(FP16_BLS48556 *x, FP16_BLS48556 *y);
 ...
 *
	...
	@param b BIG number
 */
extern void FP16_BLS48556_pow(FP16_BLS48556 *x, FP16_BLS48556 *y, BIG_560_29 b);
/**	@brief Raises an FP16 to the power of the internal modulus p, using the Frobenius
 *
	@param x FP16 instance, on exit = x^p
	@param f FP2 precalculated Frobenius constant
 */
extern void FP16_BLS48556_frob(FP16_BLS48556 *x, FP2_BLS48556 *f);
 ...
 *
	...
	@param z FP16 instance
 */
extern void FP16_BLS48556_xtr_A(FP16_BLS48556 *r, FP16_BLS48556 *w, FP16_BLS48556 *x, FP16_BLS48556 *y, FP16_BLS48556 *z);
/**	@brief Calculates the XTR doubling function r=x^2-2*conj(x)
 *
	@param r FP16 instance, on exit = x^2-2*conj(x)
	@param x FP16 instance
 */
extern void FP16_BLS48556_xtr_D(FP16_BLS48556 *r, FP16_BLS48556 *x);
 ...
 *
	...
	@param b BIG number
 */
extern void FP16_BLS48556_xtr_pow(FP16_BLS48556 *r, FP16_BLS48556 *x, BIG_560_29 b);
 ...
 *
	...
	@param b BIG number
 */
extern void FP16_BLS48556_xtr_pow2(FP16_BLS48556 *r, FP16_BLS48556 *c, FP16_BLS48556 *d, FP16_BLS48556 *e, FP16_BLS48556 *f, BIG_560_29 a, BIG_560_29 b);
 ...
 */
extern void FP16_BLS48556_cmove(FP16_BLS48556 *x, FP16_BLS48556 *y, int s);
