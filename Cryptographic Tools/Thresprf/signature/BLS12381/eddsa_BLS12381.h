...
#ifndef EDDSA_BLS12381_H
#define EDDSA_BLS12381_H

#include "ecp_BLS12381.h"

#define EGS_BLS12381 MODBYTES_384_29  /**< ECC Group Size in bytes */
#define EFS_BLS12381 MODBYTES_384_29  /**< ECC Field Size in bytes */
 ...
 */
extern int EDDSA_BLS12381_KEY_PAIR_GENERATE(csprng *R, octet *D, octet *Q);
 ...
 *
	...
	@return 0 or an error code
 */
extern int EDDSA_BLS12381_SIGNATURE(bool ph,octet *D, octet *context,octet *M,octet *SIG);
 ...
 */
extern bool EDDSA_BLS12381_VERIFY(bool ph,octet *Q,octet *context,octet *M,octet *SIG);
#endif