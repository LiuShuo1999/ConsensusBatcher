...
#ifndef FP12_FP512BN_H
#define FP12_FP512BN_H
...
typedef struct
{
    FP4_FP512BN a; /**< first part of FP12 */
    FP4_FP512BN b; /**< second part of FP12 */
    FP4_FP512BN c; /**< third part of FP12 */
 ...
 */
extern int FP12_FP512BN_equals(FP12_FP512BN *x, FP12_FP512BN *y);
 ...
 */
extern void FP12_FP512BN_conj(FP12_FP512BN *x, FP12_FP512BN *y);
 ...
 */
extern void FP12_FP512BN_from_FP4(FP12_FP512BN *x, FP4_FP512BN *a);
 ...
 */
extern void FP12_FP512BN_from_FP4s(FP12_FP512BN *x, FP4_FP512BN *a, FP4_FP512BN* b, FP4_FP512BN *c);
/**	@brief Fast Squaring of an FP12 in "unitary" form
 *
	@param x FP12 instance, on exit = y^2
	@param y FP4 instance, must be unitary
 */
extern void FP12_FP512BN_usqr(FP12_FP512BN *x, FP12_FP512BN *y);
/**	@brief Squaring an FP12
 *
	@param x FP12 instance, on exit = y^2
	@param y FP12 instance
 */
extern void FP12_FP512BN_sqr(FP12_FP512BN *x, FP12_FP512BN *y);
 ...
 */
extern void FP12_FP512BN_smul(FP12_FP512BN *x, FP12_FP512BN *y);
 ...
 *
	...
	@param y FP12 instance, of special form
 */
extern void FP12_FP512BN_ssmul(FP12_FP512BN *x, FP12_FP512BN *y);
 ...
 */
extern void FP12_FP512BN_mul(FP12_FP512BN *x, FP12_FP512BN *y);
/**	@brief Inverting an FP12
 *
	@param x FP12 instance, on exit = 1/y
	@param y FP12 instance
 */
extern void FP12_FP512BN_inv(FP12_FP512BN *x, FP12_FP512BN *y);
 ...
 *
	...
	@param b BIG number
 */
extern void FP12_FP512BN_pow(FP12_FP512BN *r, FP12_FP512BN *x, BIG_512_29 b);
 ...
 */
extern void FP12_FP512BN_pinpow(FP12_FP512BN *x, int i, int b);
 ...
 */
extern void FP12_FP512BN_compow(FP4_FP512BN *c, FP12_FP512BN *x, BIG_512_29 e, BIG_512_29 r);
 ...
 */
extern void FP12_FP512BN_toOctet(octet *S, FP12_FP512BN *x);
 ...
 */
extern void FP12_FP512BN_fromOctet(FP12_FP512BN *x, octet *S);
 ...
 */
extern void FP12_FP512BN_trace(FP4_FP512BN *t, FP12_FP512BN *x);
 ...
 */
extern void FP12_FP512BN_cmove(FP12_FP512BN *x, FP12_FP512BN *y, int s);
