...
#ifndef FP2_BLS24479_H
#define FP2_BLS24479_H
...
typedef struct
{
    FP_BLS24479 a; /**< real part of FP2 */
    FP_BLS24479 b; /**< imaginary part of FP2 */
} FP2_BLS24479;
 ...
 */
extern int FP2_BLS24479_iszilch(FP2_BLS24479 *x);
 ...
 */
extern int FP2_BLS24479_islarger(FP2_BLS24479 *x);
 ...
 */
extern void FP2_BLS24479_toBytes(char *b,FP2_BLS24479 *x);
 ...
 */
extern void FP2_BLS24479_fromBytes(FP2_BLS24479 *x,char *b);
 ...
 */
extern void FP2_BLS24479_cmove(FP2_BLS24479 *x, FP2_BLS24479 *y, int s);
/**	@brief Tests for FP2 equal to one
 *
	@param x FP2 instance to be tested
	@return 1 if x=1, else returns 0
 */
extern int FP2_BLS24479_isunity(FP2_BLS24479 *x);
 ...
 */
extern int FP2_BLS24479_equals(FP2_BLS24479 *x, FP2_BLS24479 *y);
 ...
 */
extern void FP2_BLS24479_from_FPs(FP2_BLS24479 *x, FP_BLS24479 *a, FP_BLS24479 *b);
 ...
 */
extern void FP2_BLS24479_from_BIGs(FP2_BLS24479 *x, BIG_480_29 a, BIG_480_29 b);
 ...
 */
extern void FP2_BLS24479_from_ints(FP2_BLS24479 *x, int a, int b);
 ...
 *
	...
	@param a FP to form real part of FP2
 */
extern void FP2_BLS24479_from_FP(FP2_BLS24479 *x, FP_BLS24479 *a);
 ...
 */
extern void FP2_BLS24479_rcopy(FP2_BLS24479 *w,const BIG_480_29 a,const BIG_480_29 b);
 ...
 *
	...
	@return "sign" of FP2
 */
extern int FP2_BLS24479_sign(FP2_BLS24479 *x);
 ...
 */
extern void FP2_BLS24479_neg(FP2_BLS24479 *x, FP2_BLS24479 *y);
 ...
 *
	...
	@param y FP2 instance
 */
extern void FP2_BLS24479_conj(FP2_BLS24479 *x, FP2_BLS24479 *y);
 ...
 */
extern void FP2_BLS24479_add(FP2_BLS24479 *x, FP2_BLS24479 *y, FP2_BLS24479 *z);
 ...
 *
	...
	@param z FP2 instance
 */
extern void FP2_BLS24479_sub(FP2_BLS24479 *x, FP2_BLS24479 *y, FP2_BLS24479 *z);
 ...
 *
	...
	@param b FP residue
 */
extern void FP2_BLS24479_pmul(FP2_BLS24479 *x, FP2_BLS24479 *y, FP_BLS24479 *b);
 ...
 *
	...
	@param i an integer
 */
extern void FP2_BLS24479_imul(FP2_BLS24479 *x, FP2_BLS24479 *y, int i);
/**	@brief Squaring an FP2
 *
	@param x FP2 instance, on exit = y^2
	@param y FP2 instance
 */
extern void FP2_BLS24479_sqr(FP2_BLS24479 *x, FP2_BLS24479 *y);
 ...
 *
	...
	@param z FP2 instance
 */
extern void FP2_BLS24479_mul(FP2_BLS24479 *x, FP2_BLS24479 *y, FP2_BLS24479 *z);
/**	@brief Formats and outputs an FP2 to the console
 *
	@param x FP2 instance
 */
extern void FP2_BLS24479_output(FP2_BLS24479 *x);
/**	@brief Formats and outputs an FP2 to the console in raw form (for debugging)
 *
	@param x FP2 instance
 */
extern void FP2_BLS24479_rawoutput(FP2_BLS24479 *x);
 ...
 *
	...
	@param b BIG number
 */
extern void FP2_BLS24479_pow(FP2_BLS24479 *x, FP2_BLS24479 *y, BIG_480_29 b);
 ...
 */
extern int FP2_BLS24479_qr(FP2_BLS24479 *x, FP_BLS24479 *h);
 ...
 *
    ...
    @param h optional input hint
 */
extern void FP2_BLS24479_sqrt(FP2_BLS24479 *x, FP2_BLS24479 *y, FP_BLS24479 *h);
 ...
 */
extern void FP2_BLS24479_times_i(FP2_BLS24479 *x);
/**	@brief Generate random FP2
 *
	@param x random FP2 number
	@param rng random number generator
 */
extern void FP2_BLS24479_rand(FP2_BLS24479 *x, csprng *rng);
#endif
