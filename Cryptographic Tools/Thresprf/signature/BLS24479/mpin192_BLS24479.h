...
#ifndef MPIN192_BLS24479_H
#define MPIN192_BLS24479_H

#include "pair4_BLS24479.h"

/* Field size is assumed to be greater than or equal to group size */

#define PGS_BLS24479 MODBYTES_480_29  /**< MPIN Group Size */
#define PFS_BLS24479 MODBYTES_480_29  /**< MPIN Field Size */
...
//#define PAS_BLS24479 24        /**< MPIN Symmetric Key Size 192 bits  */
//#define HASH_TYPE_MPIN_BLS24479 SHA384   /**< Choose Hash function */
 ...
 */
int MPIN_BLS24479_EXTRACT_PIN(octet *HID, int pin, octet *CS);
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BLS24479_CLIENT_1(octet *HID, csprng *R, octet *x, int pin, octet *T, octet *S, octet *U);
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BLS24479_RANDOM_GENERATE(csprng *R, octet *S);
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BLS24479_CLIENT_2(octet *x, octet *y, octet *V);
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BLS24479_SERVER(octet *HID, octet *y, octet *SS, octet *U, octet *V);
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BLS24479_GET_CLIENT_SECRET(octet *S, octet *HID, octet *CS);
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BLS24479_GET_SERVER_SECRET(octet *S, octet *SS);
