...
#define BIGBITS_480_29 (8*MODBYTES_480_29) /**< Length in bits */
#define NLEN_480_29 (1+((8*MODBYTES_480_29-1)/BASEBITS_480_29)) /**< length in bytes */
#define DNLEN_480_29 2*NLEN_480_29 /**< Double length in bytes */
#define BMASK_480_29 (((chunk)1<<BASEBITS_480_29)-1) /**< Mask = 2^BASEBITS-1 */
#define NEXCESS_480_29 (1<<(CHUNK-BASEBITS_480_29-1))           /**< 2^(CHUNK-BASEBITS-1) - digit cannot be multiplied by more than this before normalisation */

#define HBITS_480_29 (BASEBITS_480_29/2)      /**< Number of bits in number base divided by 2 */
#define HMASK_480_29 (((chunk)1<<HBITS_480_29)-1)    /**< Mask = 2^HBITS-1 */

//#define DEBUG_NORM

#ifdef DEBUG_NORM  /* Add an extra location to track chunk extension */
#define MPV_480_29 NLEN_480_29
#define MNV_480_29 (NLEN_480_29+1)
typedef chunk BIG_480_29[NLEN_480_29 + 2]; /**< Define type BIG as array of chunks */
#define DMPV_480_29 DNLEN_480_29
#define DMNV_480_29 (DNLEN_480_29+1)
typedef chunk DBIG_480_29[DNLEN_480_29 + 2]; /**< Define type DBIG as array of chunks */
#else
typedef chunk BIG_480_29[NLEN_480_29];     /**< Define type BIG as array of chunks */
typedef chunk DBIG_480_29[DNLEN_480_29];   /**< Define type DBIG as array of chunks */
#endif
 ...
 *
    ...
    @return ignore
 */
extern chunk BIG_480_29_cswap(BIG_480_29 x, BIG_480_29 y, int s);
 ...
 *
    ...
    @return ignore
 */
extern chunk BIG_480_29_cmove(BIG_480_29 x, BIG_480_29 y, int s);
 ...
 *
    ...
    @return ignore
 */
extern chunk BIG_480_29_dcmove(BIG_480_29 x, BIG_480_29 y, int s);
/**	@brief Convert from BIG number to byte array (Constant Time)
 *
	@param a byte array
	@param x BIG number
 */
extern void BIG_480_29_toBytes(char *a, BIG_480_29 x);
/**	@brief Convert to BIG number from byte array (Constant Time)
 *
	@param x BIG number
	@param a byte array
 */
extern void BIG_480_29_fromBytes(BIG_480_29 x, char *a);
 ...
 */
extern void BIG_480_29_fromBytesLen(BIG_480_29 x, char *a, int s);
 ...
 *
   ...
   @param s byte array length
 */
extern void BIG_480_29_dfromBytesLen(DBIG_480_29 x, char *a, int s);
/**	@brief Outputs a DBIG number to the console (Variable Time)
 *
	@param x a DBIG number
 */
extern void BIG_480_29_doutput(DBIG_480_29 x);

/**	@brief Outputs a DBIG number to the console (Variable Time)
 *
	@param x a DBIG number
 */
extern void BIG_480_29_drawoutput(DBIG_480_29 x);
 ...
 *
	...
	@param z BIG number
 */
extern void BIG_480_29_add(BIG_480_29 x, BIG_480_29 y, BIG_480_29 z);
 ...
 *
	...
	@param z BIG number
 */
extern void BIG_480_29_or(BIG_480_29 x, BIG_480_29 y, BIG_480_29 z);
 ...
 *
	...
	@param i integer
 */
extern void BIG_480_29_inc(BIG_480_29 x, int i);
 ...
 *
	...
	@param z BIG number
 */
extern void BIG_480_29_sub(BIG_480_29 x, BIG_480_29 y, BIG_480_29 z);
/**	@brief Decrement BIG by a small integer - output not normalised (Constant Time)
 *
	@param x BIG number to be decremented
	@param i integer
 */
extern void BIG_480_29_dec(BIG_480_29 x, int i);
 ...
 *
	...
	@param z DBIG number
 */
extern void BIG_480_29_dadd(DBIG_480_29 x, DBIG_480_29 y, DBIG_480_29 z);
 ...
 *
	...
	@param z DBIG number
 */
extern void BIG_480_29_dsub(DBIG_480_29 x, DBIG_480_29 y, DBIG_480_29 z);
 ...
 */
extern void BIG_480_29_imul(BIG_480_29 x, BIG_480_29 y, int i);
 ...
 */
extern chunk BIG_480_29_pmul(BIG_480_29 x, BIG_480_29 y, int i);
/**	@brief Divide BIG by 3 - output normalised (Constant Time)
 *
	@param x BIG number
	@return Remainder
 */
extern int BIG_480_29_div3(BIG_480_29 x);
 ...
 *
	...
	@param i small integer
 */
extern void BIG_480_29_pxmul(DBIG_480_29 x, BIG_480_29 y, int i);
 ...
 *
	...
	@param z BIG number
 */
extern void BIG_480_29_mul(DBIG_480_29 x, BIG_480_29 y, BIG_480_29 z);
 ...
 *
	...
	@param z BIG number
 */
extern void BIG_480_29_smul(BIG_480_29 x, BIG_480_29 y, BIG_480_29 z);
 ...
 */
extern void BIG_480_29_sqr(DBIG_480_29 x, BIG_480_29 y);
 ...
 */
extern void BIG_480_29_monty(BIG_480_29 a, BIG_480_29 md, chunk MC, DBIG_480_29 d);
 ...
 */
extern void BIG_480_29_shl(BIG_480_29 x, int s);
 ...
 */
extern int BIG_480_29_fshl(BIG_480_29 x, int s);
 ...
 *
	...
	@return sign of r
 */
extern int BIG_480_29_ssn(BIG_480_29 r, BIG_480_29 a, BIG_480_29 m);
 ...
 */
extern chunk BIG_480_29_split(BIG_480_29 x, BIG_480_29 y, DBIG_480_29 z, int s);
 ...
 */
extern chunk BIG_480_29_norm(BIG_480_29 x);
 ...
 */
extern void BIG_480_29_dnorm(DBIG_480_29 x);
 ...
 */
extern int BIG_480_29_comp(BIG_480_29 x, BIG_480_29 y);
 ...
 */
extern void BIG_480_29_ctmod(BIG_480_29 x, BIG_480_29 n, int bd);
 ...
 */
extern void BIG_480_29_ctdmod(BIG_480_29 x, DBIG_480_29 y, BIG_480_29 n, int bd);
 ...
 *
    ...
    @param bd non-negative bit difference between maximum x and n
 */
extern void BIG_480_29_ctsdiv(BIG_480_29 x,BIG_480_29 n,int bd);
 ...
 *
    ...
    @param bd non-negative bit difference between maximum y and n
 */
extern void BIG_480_29_ctddiv(BIG_480_29 x, DBIG_480_29 y, BIG_480_29 n,int bd);
 ...
 *
	...
	@param n The modulus
 */
extern void BIG_480_29_mod(BIG_480_29 x, BIG_480_29 n); 
 ...
 *
	...
	@param n The Divisor
 */
extern void BIG_480_29_sdiv(BIG_480_29 x, BIG_480_29 n);
 ...
 *
	...
	@param n Modulus
 */
extern void BIG_480_29_dmod(BIG_480_29 x, DBIG_480_29 y, BIG_480_29 n);
 ...
 *
	...
	@param n Modulus
 */
extern void BIG_480_29_ddiv(BIG_480_29 x, DBIG_480_29 y, BIG_480_29 n);
/**	@brief  return parity of BIG, that is the least significant bit (Constant Time)
 *
	@param x BIG number
	@return 0 or 1
 */
extern int BIG_480_29_parity(BIG_480_29 x);
 ...
 *
	...
	@return 0 or 1
 */
extern int BIG_480_29_bit(BIG_480_29 x, int i);
 ...
 */
extern int BIG_480_29_lastbits(BIG_480_29 x, int n);
 ...
 */
extern void BIG_480_29_random(BIG_480_29 x, csprng *r);
 ...
 *
	...
	@param r A pointer to a Cryptographically Secure Random Number Generator
 */
extern void BIG_480_29_randomnum(BIG_480_29 x, BIG_480_29 n, csprng *r);
 ...
 *
	...
	@param r A pointer to a Cryptographically Secure Random Number Generator
 */
extern void BIG_480_29_randtrunc(BIG_480_29 x, BIG_480_29 n, int t, csprng *r);
 ...
 */
extern void BIG_480_29_modmul(BIG_480_29 x, BIG_480_29 y, BIG_480_29 z, BIG_480_29 n);
/**	@brief  Calculate x=y/z mod n (Variable Time)
 *
	...
	@param n The BIG Modulus
 */
extern void BIG_480_29_moddiv(BIG_480_29 x, BIG_480_29 y, BIG_480_29 z, BIG_480_29 n);
 ...
 *
	...
	@param n The BIG Modulus
 */
extern void BIG_480_29_modsqr(BIG_480_29 x, BIG_480_29 y, BIG_480_29 n);
 ...
 *
	...
	@param n The BIG Modulus
 */
extern void BIG_480_29_modneg(BIG_480_29 x, BIG_480_29 y, BIG_480_29 n);
 ...
 *
	...
	@param n The BIG Modulus
 */
extern void BIG_480_29_modadd(BIG_480_29 x, BIG_480_29 y, BIG_480_29 z, BIG_480_29 n);
 ...
 */
extern int BIG_480_29_jacobi(BIG_480_29 x, BIG_480_29 y);
 ...
 *
	...
	@param n The BIG Modulus
 */
extern void BIG_480_29_invmodp(BIG_480_29 x, BIG_480_29 y, BIG_480_29 n);
...
*/
extern void BIG_480_29_mod2m(BIG_480_29 x, int m);
...
static inline chunk muladd_480_29(chunk x, chunk y, chunk c, chunk *r)
{
    dchunk prod = (dchunk)x * y + c + *r;
    *r = (chunk)prod & BMASK_480_29;
    return (chunk)(prod >> BASEBITS_480_29);
}
