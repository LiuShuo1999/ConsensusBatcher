...
#define CURVETYPE_BN158 WEIERSTRASS          /**< Define Curve Type */
#define CURVE_A_BN158 0            /**< Curve A parameter */
#define PAIRING_FRIENDLY_BN158 BN_CURVE   /**< Is curve pairing-friendly */
#define CURVE_SECURITY_BN158 128     /**< Curve security level in AES bits */
#define HTC_ISO_BN158 0            /**< Use Isogenies for Hash to Curve */
...
#define HTC_ISO_G2_BN158 0        /**< Use Isogenies for G2 Hash to Curve */
...
#define USE_GS_GT_BN158 /**< Not patented, so probably OK to always use this */

#define POSITIVEX 0
#define NEGATIVEX 1

#define SEXTIC_TWIST_BN158 M_TYPE       /**< Sextic Twist M or D type */
#define SIGN_OF_X_BN158 NEGATIVEX          /**< Sign of curve parameter */ 

#define ATE_BITS_BN158 42           /**< Number of Bits in curve parameter */
#define G2_TABLE_BN158 49           /**< Size of table for pairing precomputation for fixed G2 */
