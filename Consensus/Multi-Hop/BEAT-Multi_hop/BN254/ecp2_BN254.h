...
extern const BIG_256_28 CURVE_Bnx_BN254;   /**< Elliptic curve parameter */
 ...
 */
extern void ECP2_BN254_toOctet(octet *S, ECP2_BN254 *P, bool c);
 ...
 *
	...
	@return 1 if point exists, else 0
 */
extern int ECP2_BN254_setx(ECP2_BN254 *P, FP2_BN254 *x, int s);
 ...
 */
extern void ECP2_BN254_mul(ECP2_BN254 *P, BIG_256_28 b);
 ...
 */
extern void ECP2_BN254_mul4(ECP2_BN254 *P, ECP2_BN254 *Q, BIG_256_28 *b);

/**	@brief Multiplies random point by co-factor
 *
	@param Q ECP2 multiplied by co-factor
 */
extern void ECP2_BN254_cfp(ECP2_BN254 *Q);
 ...
 */
extern void ECP2_BN254_map2point(ECP2_BN254 *Q, FP2_BN254 *x);
 ...
 */
extern void ECP2_BN254_hap2point(ECP2_BN254 *Q, BIG_256_28  x);
 ...
 *
	...
	@return 1 if point exists, else 0
 */
extern int ECP2_BN254_generator(ECP2_BN254 *G);
