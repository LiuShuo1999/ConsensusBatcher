...
#ifndef EDDSA_BN254_H
#define EDDSA_BN254_H
 ...
 */
extern int EDDSA_BN254_KEY_PAIR_GENERATE(csprng *R, octet *D, octet *Q);
 ...
 *
	...
	@return 0 or an error code
 */
extern int EDDSA_BN254_SIGNATURE(bool ph,octet *D, octet *context,octet *M,octet *SIG);
 ...
 */
extern bool EDDSA_BN254_VERIFY(bool ph,octet *Q,octet *context,octet *M,octet *SIG);
#endif