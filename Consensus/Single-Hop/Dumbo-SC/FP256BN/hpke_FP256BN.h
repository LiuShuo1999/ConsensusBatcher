...
#ifndef HPKE_FP256BN_H
#define HPKE_FP256BN_H
 ...
 */
extern int DeriveKeyPair_FP256BN(int config_id,octet *SK,octet *PK,octet *SEED);
 ...
 */
extern void HPKE_FP256BN_Encap(int config_id,octet *SK,octet *Z,octet *pkE,octet *pkR);
 ...
 */
extern void HPKE_FP256BN_Decap(int config_id,octet *skR,octet *Z,octet *pkE,octet *pkR);
 ...
 */
extern void HPKE_FP256BN_AuthEncap(int config_id,octet *skE,octet *skS,octet *Z,octet *pkE,octet *pkR,octet *pkS);
 ...
 *
    ...
    @param pkS the Initiators public key
 */
extern void HPKE_FP256BN_AuthDecap(int config_id,octet *skR,octet *Z,octet *pkE,octet *pkR,octet *pkS);
 ...
 */
extern void HPKE_FP256BN_KeySchedule(int config_id,octet *key,octet *nonce,octet *exp_secret,int mode,octet *Z,octet *info,octet *psk,octet *pskID);
