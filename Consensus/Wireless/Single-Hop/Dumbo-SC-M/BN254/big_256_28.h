...
//(1+((8*32-1)/28))
#define BIGBITS_256_28 (8*MODBYTES_256_28) /**< Length in bits */
#define NLEN_256_28 (1+((8*MODBYTES_256_28-1)/BASEBITS_256_28)) /**< length in bytes */
#define DNLEN_256_28 2*NLEN_256_28 /**< Double length in bytes */
#define BMASK_256_28 (((chunk)1<<BASEBITS_256_28)-1) /**< Mask = 2^BASEBITS-1 */
#define NEXCESS_256_28 (1<<(CHUNK-BASEBITS_256_28-1))           /**< 2^(CHUNK-BASEBITS-1) - digit cannot be multiplied by more than this before normalisation */

#define HBITS_256_28 (BASEBITS_256_28/2)      /**< Number of bits in number base divided by 2 */
#define HMASK_256_28 (((chunk)1<<HBITS_256_28)-1)    /**< Mask = 2^HBITS-1 */

//#define DEBUG_NORM

#ifdef DEBUG_NORM  /* Add an extra location to track chunk extension */
#define MPV_256_28 NLEN_256_28
#define MNV_256_28 (NLEN_256_28+1)
typedef chunk BIG_256_28[NLEN_256_28 + 2]; /**< Define type BIG as array of chunks */
#define DMPV_256_28 DNLEN_256_28
#define DMNV_256_28 (DNLEN_256_28+1)
typedef chunk DBIG_256_28[DNLEN_256_28 + 2]; /**< Define type DBIG as array of chunks */
#else
typedef chunk BIG_256_28[NLEN_256_28];     /**< Define type BIG as array of chunks */
typedef chunk DBIG_256_28[DNLEN_256_28];   /**< Define type DBIG as array of chunks */
#endif
 ...
 *
    ...
    @return ignore
 */
extern chunk BIG_256_28_cswap(BIG_256_28 x, BIG_256_28 y, int s);
 ...
 *
    ...
    @return ignore
 */
extern chunk BIG_256_28_cmove(BIG_256_28 x, BIG_256_28 y, int s);
 ...
 *
    ...
    @return ignore
 */
extern chunk BIG_256_28_dcmove(BIG_256_28 x, BIG_256_28 y, int s);
/**	@brief Convert from BIG number to byte array (Constant Time)
 *
	@param a byte array
	@param x BIG number
 */
extern void BIG_256_28_toBytes(char *a, BIG_256_28 x);
/**	@brief Convert to BIG number from byte array (Constant Time)
 *
	@param x BIG number
	@param a byte array
 */
extern void BIG_256_28_fromBytes(BIG_256_28 x, char *a);
 ...
 */
extern void BIG_256_28_fromBytesLen(BIG_256_28 x, char *a, int s);
 ...
 *
   ...
   @param s byte array length
 */
extern void BIG_256_28_dfromBytesLen(DBIG_256_28 x, char *a, int s);
/**	@brief Outputs a DBIG number to the console (Variable Time)
 *
	@param x a DBIG number
 */
extern void BIG_256_28_doutput(DBIG_256_28 x);

/**	@brief Outputs a DBIG number to the console (Variable Time)
 *
	@param x a DBIG number
 */
extern void BIG_256_28_drawoutput(DBIG_256_28 x);
 ...
 *
	...
	@param z BIG number
 */
extern void BIG_256_28_add(BIG_256_28 x, BIG_256_28 y, BIG_256_28 z);
 ...
 *
	...
	@param z BIG number
 */
extern void BIG_256_28_or(BIG_256_28 x, BIG_256_28 y, BIG_256_28 z);
 ...
 *
	...
	@param i integer
 */
extern void BIG_256_28_inc(BIG_256_28 x, int i);
 ...
 *
	...
	@param z BIG number
 */
extern void BIG_256_28_sub(BIG_256_28 x, BIG_256_28 y, BIG_256_28 z);
/**	@brief Decrement BIG by a small integer - output not normalised (Constant Time)
 *
	@param x BIG number to be decremented
	@param i integer
 */
extern void BIG_256_28_dec(BIG_256_28 x, int i);
 ...
 *
	...
	@param z DBIG number
 */
extern void BIG_256_28_dadd(DBIG_256_28 x, DBIG_256_28 y, DBIG_256_28 z);
 ...
 *
	...
	@param z DBIG number
 */
extern void BIG_256_28_dsub(DBIG_256_28 x, DBIG_256_28 y, DBIG_256_28 z);
 ...
 */
extern void BIG_256_28_imul(BIG_256_28 x, BIG_256_28 y, int i);
 ...
 */
extern chunk BIG_256_28_pmul(BIG_256_28 x, BIG_256_28 y, int i);
/**	@brief Divide BIG by 3 - output normalised (Constant Time)
 *
	@param x BIG number
	@return Remainder
 */
extern int BIG_256_28_div3(BIG_256_28 x);
 ...
 *
	...
	@param i small integer
 */
extern void BIG_256_28_pxmul(DBIG_256_28 x, BIG_256_28 y, int i);
 ...
 *
	...
	@param z BIG number
 */
extern void BIG_256_28_mul(DBIG_256_28 x, BIG_256_28 y, BIG_256_28 z);
 ...
 *
	...
	@param z BIG number
 */
extern void BIG_256_28_smul(BIG_256_28 x, BIG_256_28 y, BIG_256_28 z);
 ...
 */
extern void BIG_256_28_sqr(DBIG_256_28 x, BIG_256_28 y);
 ...
 */
extern void BIG_256_28_monty(BIG_256_28 a, BIG_256_28 md, chunk MC, DBIG_256_28 d);
 ...
 */
extern void BIG_256_28_shl(BIG_256_28 x, int s);
 ...
 */
extern int BIG_256_28_fshl(BIG_256_28 x, int s);
 ...
 *
	...
	@return sign of r
 */
extern int BIG_256_28_ssn(BIG_256_28 r, BIG_256_28 a, BIG_256_28 m);
 ...
 */
extern chunk BIG_256_28_split(BIG_256_28 x, BIG_256_28 y, DBIG_256_28 z, int s);
 ...
 */
extern chunk BIG_256_28_norm(BIG_256_28 x);
 ...
 */
extern void BIG_256_28_dnorm(DBIG_256_28 x);
 ...
 */
extern int BIG_256_28_comp(BIG_256_28 x, BIG_256_28 y);
 ...
 */
extern void BIG_256_28_ctmod(BIG_256_28 x, BIG_256_28 n, int bd);
 ...
 */
extern void BIG_256_28_ctdmod(BIG_256_28 x, DBIG_256_28 y, BIG_256_28 n, int bd);
 ...
 *
    ...
    @param bd non-negative bit difference between maximum x and n
 */
extern void BIG_256_28_ctsdiv(BIG_256_28 x,BIG_256_28 n,int bd);
 ...
 *
    ...
    @param bd non-negative bit difference between maximum y and n
 */
extern void BIG_256_28_ctddiv(BIG_256_28 x, DBIG_256_28 y, BIG_256_28 n,int bd);
 ...
 *
	...
	@param n The modulus
 */
extern void BIG_256_28_mod(BIG_256_28 x, BIG_256_28 n); 
 ...
 *
	...
	@param n The Divisor
 */
extern void BIG_256_28_sdiv(BIG_256_28 x, BIG_256_28 n);
 ...
 *
	...
	@param n Modulus
 */
extern void BIG_256_28_dmod(BIG_256_28 x, DBIG_256_28 y, BIG_256_28 n);
 ...
 *
	...
	@param n Modulus
 */
extern void BIG_256_28_ddiv(BIG_256_28 x, DBIG_256_28 y, BIG_256_28 n);
/**	@brief  return parity of BIG, that is the least significant bit (Constant Time)
 *
	@param x BIG number
	@return 0 or 1
 */
extern int BIG_256_28_parity(BIG_256_28 x);
 ...
 *
	...
	@return 0 or 1
 */
extern int BIG_256_28_bit(BIG_256_28 x, int i);
 ...
 */
extern int BIG_256_28_lastbits(BIG_256_28 x, int n);
 ...
 */
extern void BIG_256_28_random(BIG_256_28 x, csprng *r);
 ...
 *
	...
	@param r A pointer to a Cryptographically Secure Random Number Generator
 */
extern void BIG_256_28_randomnum(BIG_256_28 x, BIG_256_28 n, csprng *r);
 ...
 *
	...
	@param r A pointer to a Cryptographically Secure Random Number Generator
 */
extern void BIG_256_28_randtrunc(BIG_256_28 x, BIG_256_28 n, int t, csprng *r);
 ...
 */
extern void BIG_256_28_modmul(BIG_256_28 x, BIG_256_28 y, BIG_256_28 z, BIG_256_28 n);
/**	@brief  Calculate x=y/z mod n (Variable Time)
 *
	...
	@param n The BIG Modulus
 */
extern void BIG_256_28_moddiv(BIG_256_28 x, BIG_256_28 y, BIG_256_28 z, BIG_256_28 n);
 ...
 *
	...
	@param n The BIG Modulus
 */
extern void BIG_256_28_modsqr(BIG_256_28 x, BIG_256_28 y, BIG_256_28 n);
 ...
 *
	...
	@param n The BIG Modulus
 */
extern void BIG_256_28_modneg(BIG_256_28 x, BIG_256_28 y, BIG_256_28 n);
 ...
 *
	...
	@param n The BIG Modulus
 */
extern void BIG_256_28_modadd(BIG_256_28 x, BIG_256_28 y, BIG_256_28 z, BIG_256_28 n);
 ...
 */
extern int BIG_256_28_jacobi(BIG_256_28 x, BIG_256_28 y);
 ...
 *
	...
	@param n The BIG Modulus
 */
extern void BIG_256_28_invmodp(BIG_256_28 x, BIG_256_28 y, BIG_256_28 n);
...
*/
extern void BIG_256_28_mod2m(BIG_256_28 x, int m);
...
static inline chunk muladd_256_28(chunk x, chunk y, chunk c, chunk *r)
{
    dchunk prod = (dchunk)x * y + c + *r;
    *r = (chunk)prod & BMASK_256_28;
    return (chunk)(prod >> BASEBITS_256_28);
}
