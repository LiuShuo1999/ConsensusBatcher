...
typedef struct
{
    FP4_BN158 a; /**< first part of FP12 */
    FP4_BN158 b; /**< second part of FP12 */
    FP4_BN158 c; /**< third part of FP12 */
 ...
 */
extern int FP12_BN158_equals(FP12_BN158 *x, FP12_BN158 *y);
 ...
 */
extern void FP12_BN158_conj(FP12_BN158 *x, FP12_BN158 *y);
 ...
 */
extern void FP12_BN158_from_FP4(FP12_BN158 *x, FP4_BN158 *a);
 ...
 */
extern void FP12_BN158_from_FP4s(FP12_BN158 *x, FP4_BN158 *a, FP4_BN158* b, FP4_BN158 *c);
/**	@brief Fast Squaring of an FP12 in "unitary" form
 *
	@param x FP12 instance, on exit = y^2
	@param y FP4 instance, must be unitary
 */
extern void FP12_BN158_usqr(FP12_BN158 *x, FP12_BN158 *y);
/**	@brief Squaring an FP12
 *
	@param x FP12 instance, on exit = y^2
	@param y FP12 instance
 */
extern void FP12_BN158_sqr(FP12_BN158 *x, FP12_BN158 *y);
 ...
 */
extern void FP12_BN158_smul(FP12_BN158 *x, FP12_BN158 *y);
 ...
 *
	...
	@param y FP12 instance, of special form
 */
extern void FP12_BN158_ssmul(FP12_BN158 *x, FP12_BN158 *y);
 ...
 */
extern void FP12_BN158_mul(FP12_BN158 *x, FP12_BN158 *y);
/**	@brief Inverting an FP12
 *
	@param x FP12 instance, on exit = 1/y
	@param y FP12 instance
 */
extern void FP12_BN158_inv(FP12_BN158 *x, FP12_BN158 *y);
 ...
 *
	...
	@param b BIG number
 */
extern void FP12_BN158_pow(FP12_BN158 *r, FP12_BN158 *x, BIG_160_28 b);
 ...
 */
extern void FP12_BN158_pinpow(FP12_BN158 *x, int i, int b);
 ...
 */
extern void FP12_BN158_compow(FP4_BN158 *c, FP12_BN158 *x, BIG_160_28 e, BIG_160_28 r);
 ...
 */
extern void FP12_BN158_toOctet(octet *S, FP12_BN158 *x);
 ...
 */
extern void FP12_BN158_fromOctet(FP12_BN158 *x, octet *S);
 ...
 */
extern void FP12_BN158_trace(FP4_BN158 *t, FP12_BN158 *x);
 ...
 */
extern void FP12_BN158_cmove(FP12_BN158 *x, FP12_BN158 *y, int s);
