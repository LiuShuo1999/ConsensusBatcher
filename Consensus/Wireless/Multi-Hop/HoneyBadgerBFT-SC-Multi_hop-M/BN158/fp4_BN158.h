...
typedef struct
{
    FP2_BN158 a; /**< real part of FP4 */
    FP2_BN158 b; /**< imaginary part of FP4 */
} FP4_BN158;
 ...
 */
extern int FP4_BN158_iszilch(FP4_BN158 *x);
 ...
 */
extern int FP4_BN158_islarger(FP4_BN158 *x);
 ...
 */
extern void FP4_BN158_toBytes(char *b,FP4_BN158 *x);
 ...
 */
extern void FP4_BN158_fromBytes(FP4_BN158 *x,char *b);
 ...
 */
extern int FP4_BN158_isunity(FP4_BN158 *x);
 ...
 */
extern void FP4_BN158_from_FP2s(FP4_BN158 *x, FP2_BN158 *a, FP2_BN158 *b);
 ...
 *
	...
	@param a FP2 to form real part of FP4
 */
extern void FP4_BN158_from_FP2(FP4_BN158 *x, FP2_BN158 *a);
 ...
 */
extern void FP4_BN158_from_FP2H(FP4_BN158 *x, FP2_BN158 *a);
 ...
 */
extern void FP4_BN158_from_FP(FP4_BN158 *x, FP_BN158 *a);
 ...
 */
extern void FP4_BN158_copy(FP4_BN158 *x, FP4_BN158 *y);
/**	@brief Set FP4 to zero
 *
	@param x FP4 instance to be set to zero
 */
extern void FP4_BN158_zero(FP4_BN158 *x);
/**	@brief Set FP4 to unity
 *
	@param x FP4 instance to be set to one
 */
extern void FP4_BN158_one(FP4_BN158 *x);
 ...
 *
	...
	@return "sign" of FP4
 */
extern int FP4_BN158_sign(FP4_BN158 *x);
 ...
 */
extern void FP4_BN158_neg(FP4_BN158 *x, FP4_BN158 *y);
 ...
 *
	...
	@param y FP4 instance
 */
extern void FP4_BN158_conj(FP4_BN158 *x, FP4_BN158 *y);
 ...
 *
	...
	@param y FP4 instance
 */
extern void FP4_BN158_nconj(FP4_BN158 *x, FP4_BN158 *y);
 ...
 */
extern void FP4_BN158_add(FP4_BN158 *x, FP4_BN158 *y, FP4_BN158 *z);
 ...
 *
	...
	@param z FP4 instance
 */
extern void FP4_BN158_sub(FP4_BN158 *x, FP4_BN158 *y, FP4_BN158 *z);
 ...
 */
extern void FP4_BN158_pmul(FP4_BN158 *x, FP4_BN158 *y, FP2_BN158 *a);
 ...
 */
extern void FP4_BN158_qmul(FP4_BN158 *x, FP4_BN158 *y, FP_BN158 *a);
 ...
 *
	...
	@param i an integer
 */
extern void FP4_BN158_imul(FP4_BN158 *x, FP4_BN158 *y, int i);
/**	@brief Squaring an FP4
 *
	@param x FP4 instance, on exit = y^2
	@param y FP4 instance
 */
extern void FP4_BN158_sqr(FP4_BN158 *x, FP4_BN158 *y);
 ...
 *
	...
	@param z FP4 instance
 */
extern void FP4_BN158_mul(FP4_BN158 *x, FP4_BN158 *y, FP4_BN158 *z);
 ...
 *
	...
	@param z FP4 instance
 */
extern void FP4_BN158_xtr_A(FP4_BN158 *r, FP4_BN158 *w, FP4_BN158 *x, FP4_BN158 *y, FP4_BN158 *z);
/**	@brief Calculates the XTR doubling function r=x^2-2*conj(x)
 *
	@param r FP4 instance, on exit = x^2-2*conj(x)
	@param x FP4 instance
 */
extern void FP4_BN158_xtr_D(FP4_BN158 *r, FP4_BN158 *x);
 ...
 *
	...
	@param b BIG number
 */
extern void FP4_BN158_xtr_pow(FP4_BN158 *r, FP4_BN158 *x, BIG_160_28 b);
 ...
 *
	...
	@param b BIG number
 */
extern void FP4_BN158_xtr_pow2(FP4_BN158 *r, FP4_BN158 *c, FP4_BN158 *d, FP4_BN158 *e, FP4_BN158 *f, BIG_160_28 a, BIG_160_28 b);
 ...
 */
extern void FP4_BN158_cmove(FP4_BN158 *x, FP4_BN158 *y, int s);
 ...
 */
extern int  FP4_BN158_qr(FP4_BN158 *r, FP_BN158 *h);
 ...
 *
	...
	@param h optional input hint
 */
extern void  FP4_BN158_sqrt(FP4_BN158 *r, FP4_BN158 *x, FP_BN158 *h);
 ...
 *
	...
	@param x FP4 instance
 */
extern void FP4_BN158_div_i(FP4_BN158 *x);
 ...
 *
	...
	@param x FP4 instance
 */
extern void FP4_BN158_div_2i(FP4_BN158 *x);
 ...
 *
	...
	@param y FP4 instance
 */
extern void FP4_BN158_div2(FP4_BN158 *x, FP4_BN158 *y);
 ...
 */
extern void FP4_BN158_rand(FP4_BN158 *x, csprng *rng);
